...
/**
 * @brief Binding of RoR::LocalStorage; A class that allows your script to store data persistently.
 *
...
public:
     ...
     * @param filename The name of the resource group where the file should be created.
