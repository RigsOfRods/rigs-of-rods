...
void GUIManager::SetupImGui()
{
    ...
    style.Colors[ImGuiCol_ChildWindowBg]         = ImVec4(0.00f, 0.00f, 0.00f, 0.88f);
    ...
    style.Colors[ImGuiCol_FrameBgActive]         = ImVec4(0.13f, 0.40f, 0.60f, 1.00f);
    ...
    style.Colors[ImGuiCol_ScrollbarGrabActive]   = ImVec4(0.13f, 0.40f, 0.60f, 1.00f);
    style.Colors[ImGuiCol_ComboBg]               = ImVec4(0.20f, 0.20f, 0.20f, 0.99f);
    style.Colors[ImGuiCol_CheckMark]             = ImVec4(0.90f, 0.90f, 0.90f, 1.00f);
    style.Colors[ImGuiCol_SliderGrab]            = ImVec4(0.90f, 0.90f, 0.90f, 0.85f);
    style.Colors[ImGuiCol_SliderGrabActive]      = ImVec4(0.90f, 0.90f, 0.90f, 1.00f);
    style.Colors[ImGuiCol_Button]                = ImVec4(0.13f, 0.40f, 0.60f, 0.70f);
    style.Colors[ImGuiCol_ButtonHovered]         = ImVec4(0.13f, 0.40f, 0.60f, 0.90f);
    style.Colors[ImGuiCol_ButtonActive]          = ImVec4(0.13f, 0.40f, 0.60f, 1.00f);
    style.Colors[ImGuiCol_Header]                = ImVec4(0.13f, 0.40f, 0.60f, 0.70f);
    style.Colors[ImGuiCol_HeaderHovered]         = ImVec4(0.13f, 0.40f, 0.60f, 0.90f);
    style.Colors[ImGuiCol_HeaderActive]          = ImVec4(0.13f, 0.40f, 0.60f, 1.00f);
    style.Colors[ImGuiCol_Column]                = ImVec4(0.13f, 0.40f, 0.60f, 0.70f);
    style.Colors[ImGuiCol_ColumnHovered]         = ImVec4(0.13f, 0.40f, 0.60f, 0.90f);
    style.Colors[ImGuiCol_ColumnActive]          = ImVec4(0.13f, 0.40f, 0.60f, 1.00f);
    style.Colors[ImGuiCol_ResizeGrip]            = ImVec4(0.13f, 0.40f, 0.60f, 0.70f);
    style.Colors[ImGuiCol_ResizeGripHovered]     = ImVec4(0.13f, 0.40f, 0.60f, 0.90f);
    style.Colors[ImGuiCol_ResizeGripActive]      = ImVec4(0.13f, 0.40f, 0.60f, 1.00f);
    ...
    style.Colors[ImGuiCol_CloseButtonActive]     = ImVec4(0.13f, 0.40f, 0.60f, 1.00f);
