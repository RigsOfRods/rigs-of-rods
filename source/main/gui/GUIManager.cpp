...
namespace RoR
{
    ...
    {
        GuiManagerImpl() : mygui(nullptr), mygui_platform(nullptr)
        {
        }
    ...
    GUIManager::GuiTheme::GuiTheme()
        : in_progress_text_color(1.f, 0.832031f, 0.f, 1.f), no_entries_text_color(0.7f, 0.7f, 0.7f, 1.f),
          error_text_color(1.f, 0.175439f, 0.175439f, 1.f), selected_entry_text_color(.9f, 0.7f, 0.05f, 1.f)
    {
        try
        {
            // Setup custom font
    ...
    void GUIManager::SetVisible_GameMainMenu(bool v)
    {
        m_impl->panel_GameMainMenu.SetVisible(v);
    }
    void GUIManager::SetVisible_GameAbout(bool v)
    {
        m_impl->panel_GameAbout.SetVisible(v);
    }
    void GUIManager::SetVisible_DebugOptions(bool v)
    {
        m_impl->panel_DebugOptions.SetVisible(v);
    }
    void GUIManager::SetVisible_MultiplayerSelector(bool v)
    {
        m_impl->panel_MultiplayerSelector.SetVisible(v);
    }
    void GUIManager::SetVisible_ChatBox(bool v)
    {
        m_impl->panel_ChatBox.SetVisible(v);
    }
    void GUIManager::SetVisible_SpawnerReport(bool v)
    {
        m_impl->panel_SpawnerReport.SetVisible(v);
    }
    void GUIManager::SetVisible_VehicleDescription(bool v)
    {
        m_impl->panel_VehicleDescription.SetVisible(v);
    }
    void GUIManager::SetVisible_MpClientList(bool v)
    {
        m_impl->panel_MpClientList.SetVisible(v);
    }
    void GUIManager::SetVisible_FrictionSettings(bool v)
    {
        m_impl->panel_FrictionSettings.SetVisible(v);
    }
    void GUIManager::SetVisible_TextureToolWindow(bool v)
    {
        m_impl->panel_TextureToolWindow.SetVisible(v);
    }
    void GUIManager::SetVisible_LoadingWindow(bool v)
    {
        m_impl->panel_LoadingWindow.SetVisible(v);
    }
    void GUIManager::SetVisible_Console(bool v)
    {
        m_impl->panel_GameConsole.SetVisible(v);
    }
    void GUIManager::SetVisible_GameSettings(bool v)
    {
        m_impl->panel_GameSettings.SetVisible(v);
    }
    void GUIManager::SetVisible_NodeBeamUtils(bool v)
    {
        m_impl->panel_NodeBeamUtils.SetVisible(v);
    }

    bool GUIManager::IsVisible_GameMainMenu()
    {
        return m_impl->panel_GameMainMenu.IsVisible();
    }
    bool GUIManager::IsVisible_GameAbout()
    {
        return m_impl->panel_GameAbout.IsVisible();
    }
    bool GUIManager::IsVisible_DebugOptions()
    {
        return m_impl->panel_DebugOptions.IsVisible();
    }
    bool GUIManager::IsVisible_MultiplayerSelector()
    {
        return m_impl->panel_MultiplayerSelector.IsVisible();
    }
    bool GUIManager::IsVisible_MainSelector()
    {
        return m_impl->panel_MainSelector.IsVisible();
    }
    bool GUIManager::IsVisible_ChatBox()
    {
        return m_impl->panel_ChatBox.IsVisible();
    }
    bool GUIManager::IsVisible_SpawnerReport()
    {
        return m_impl->panel_SpawnerReport.IsVisible();
    }
    bool GUIManager::IsVisible_VehicleDescription()
    {
        return m_impl->panel_VehicleDescription.IsVisible();
    }
    bool GUIManager::IsVisible_MpClientList()
    {
        return m_impl->panel_MpClientList.IsVisible();
    }
    bool GUIManager::IsVisible_FrictionSettings()
    {
        return m_impl->panel_FrictionSettings.IsVisible();
    }
    bool GUIManager::IsVisible_TextureToolWindow()
    {
        return m_impl->panel_TextureToolWindow.IsVisible();
    }
    bool GUIManager::IsVisible_LoadingWindow()
    {
        return m_impl->panel_LoadingWindow.IsVisible();
    }
    bool GUIManager::IsVisible_Console()
    {
        return m_impl->panel_GameConsole.IsVisible();
    }
    bool GUIManager::IsVisible_GameSettings()
    {
        return m_impl->panel_GameSettings.IsVisible();
    }
    bool GUIManager::IsVisible_TopMenubar()
    {
        return m_impl->panel_TopMenubar.IsVisible();
    }
    bool GUIManager::IsVisible_NodeBeamUtils()
    {
        return m_impl->panel_NodeBeamUtils.IsVisible();
    }

    // GUI GetInstance*()
    Console *GUIManager::GetConsole()
    {
        return &m_impl->panel_GameConsole;
    }
    GUI::MainSelector *GUIManager::GetMainSelector()
    {
        return &m_impl->panel_MainSelector;
    }
    GUI::GameMainMenu *GUIManager::GetMainMenu()
    {
        return &m_impl->panel_GameMainMenu;
    }
    GUI::GamePauseMenu *GUIManager::GetPauseMenu()
    {
        return &m_impl->panel_GamePauseMenu;
    }
    GUI::LoadingWindow *GUIManager::GetLoadingWindow()
    {
        return &m_impl->panel_LoadingWindow;
    }
    GUI::MpClientList *GUIManager::GetMpClientList()
    {
        return &m_impl->panel_MpClientList;
    }
    GUI::MultiplayerSelector *GUIManager::GetMpSelector()
    {
        return &m_impl->panel_MultiplayerSelector;
    }
    GUI::FrictionSettings *GUIManager::GetFrictionSettings()
    {
        return &m_impl->panel_FrictionSettings;
    }
    GUI::SimUtils *GUIManager::GetSimUtils()
    {
        return &m_impl->panel_SimUtils;
    }
    GUI::TopMenubar *GUIManager::GetTopMenubar()
    {
        return &m_impl->panel_TopMenubar;
    }

    GUIManager::GUIManager() : m_renderwindow_closed(false), m_impl(nullptr)
    {
        ...
        mygui_platform->initialise(RoR::App::GetOgreSubsystem()->GetRenderWindow(), gEnv->sceneManager,
    ...
    void GUIManager::DrawSimulationGui(float dt)
    {
        ...
        if (App::app_state.GetActive() == AppState::SIMULATION)
        {
            ...
            if (App::sim_state.GetActive() == SimState::PAUSED) { m_impl->panel_GamePauseMenu.Draw(); }
        }

        if (m_impl->panel_NodeBeamUtils.IsVisible()) { m_impl->panel_NodeBeamUtils.Draw(); }

        if (m_impl->panel_MessageBox.IsVisible()) { m_impl->panel_MessageBox.Draw(); }
    };
    ...
    Ogre::String GUIManager::getRandomWallpaperImage()
    {
        ...
        if (files.isNull() || files->empty())
        {
            ...
            if (files.isNull() || files->empty()) return "";
        }
        srand(time(NULL));
    ...
    void GUIManager::AddRigLoadingReport(std::string const &vehicle_name, std::string const &text, int num_errors,
    ...
    void GUIManager::SetMouseCursorVisibility(MouseCursorVisibility visi)
    {
        ...
        case MouseCursorVisibility::HIDDEN: ImGui::GetIO().MouseDrawCursor = false; return;
    ...
    {
        if (m_impl->panel_MultiplayerSelector.IsVisible()) { m_impl->panel_MultiplayerSelector.Draw(); }

        if (m_impl->panel_GameMainMenu.IsVisible()) { m_impl->panel_GameMainMenu.Draw(); }

        if (App::mp_state.GetActive() == MpState::CONNECTING) { this->DrawMpConnectingStatusBox(); }

        if (m_impl->panel_GameSettings.IsVisible()) { m_impl->panel_GameSettings.Draw(); }
    ...
    void GUIManager::DrawMpConnectingStatusBox()
    {
        ...
        ImGui::SetCursorPos(
            ImGui::GetCursorPos() +
            ImVec2(5.f, 7.f)); // NOTE: Hand aligned; I failed calculate the positioning here ~ only_a_ptr, 10/2017
    ...
    void GUIManager::ShowMessageBox(const char *title, const char *text, bool allow_close, const char *btn1_text,
