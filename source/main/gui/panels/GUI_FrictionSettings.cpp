...
namespace RoR
{
    namespace GUI
    {
        ...
        FrictionSettings::FrictionSettings() : col(0), active_gm(0), selected_gm(0), win(0)
        {
            int               x = 0, y = 0, by = 0;
            MyGUI::EditPtr    e;
            MyGUI::ScrollBar *h;
            ...
            msgwin = MyGUI::Gui::getInstance().createWidget<MyGUI::Window>("WindowCSX", 0, 0, 400, 300, MyGUI::Align::Center,
                                                                           "Overlapped");
            ...
            win = MyGUI::Gui::getInstance().createWidget<MyGUI::Window>("WindowCSX", 0, 0, 400, 500, MyGUI::Align::Center,
                                                                        "Overlapped");
            ...
            MyGUI::ComboBoxPtr cb =
                win->createWidget<MyGUI::ComboBox>("ComboBox", x, y, 115, 20, MyGUI::Align::Default, "combo_grounds");
            ...
            MyGUI::WidgetPtr p = win->createWidget<MyGUI::Widget>("PanelSkin", x, by, 370, 25, MyGUI::Align::Default);
            {
                ...
                helpTexts["solid_level"] = std::pair<UTFString, UTFString>(
                    _L("Solid ground level"),
                    _L("With this you can define how deep the solid ground is. If it is 0 then the surface "
                       "will be solid. If it is 0.1 then you'll have 10 cm of fluid on top of solid ground. If "
                       "it is 100 then the solid ground will be way deep (100m), with fluid on top."));
                ...
                lx += 20;
                h = p->createWidget<MyGUI::ScrollBar>("ScrollBarH", lx, ly, 60, 20, MyGUI::Align::Default,
                                                      "solid_strength_scroll");
                lx += 65;
                h->eventScrollChangePosition += MyGUI::newDelegate(this, &FrictionSettings::event_scroll_value);
                h->setScrollRange(1000);
                helpTexts["solid_strength"] = std::pair<UTFString, UTFString>(
                    _L("Strength"),
                    _L("This parameter raises or diminishes surface friction in a generic way. It is here so as to be "
                       "able to do quick calibrations of friction. Start with having this to 1.0 and after tuning the "
                       "rest of the surface variables, come back and play with this."));
                ...
                lx += 85;
                e->eventEditTextChange += MyGUI::newDelegate(this, &FrictionSettings::event_edit_TextChange);
                t = p->createWidget<MyGUI::TextBox>("TextBox", lx, ly, 20, 20, MyGUI::Align::Default,
                                                    "solid_static_friction_edited");
                lx += 20;
                h = p->createWidget<MyGUI::ScrollBar>("ScrollBarH", lx, ly, 60, 20, MyGUI::Align::Default,
                                                      "solid_static_friction_scroll");
                lx += 65;
                h->eventScrollChangePosition += MyGUI::newDelegate(this, &FrictionSettings::event_scroll_value);
                h->setScrollRange(1000);
                helpTexts["solid_static_friction"] = std::pair<UTFString, UTFString>(
                    _L("Static friction coef"), _L("Static friction keeps you in the same place when you are stopped on a hill. "
                                                   "In the real world this friction is "
                                                   "always bigger than dynamic friction (sliding friction). Start with 0.5 and "
                                                   "work from there. It is better to try "
                                                   "to find some experimentally validated values for this and the rest of "
                                                   "surface friction variables in the net, and "
                                                   "then to fine tune via strength."));
                ...
                e->eventEditTextChange += MyGUI::newDelegate(this, &FrictionSettings::event_edit_TextChange);
                t = p->createWidget<MyGUI::TextBox>("TextBox", lx, ly, 20, 20, MyGUI::Align::Default,
                                                    "solid_adhension_velo_edited");
                lx += 20;
                h = p->createWidget<MyGUI::ScrollBar>("ScrollBarH", lx, ly, 60, 20, MyGUI::Align::Default,
                                                      "solid_adhension_velo_scroll");
                lx += 65;
                h->eventScrollChangePosition += MyGUI::newDelegate(this, &FrictionSettings::event_scroll_value);
                h->setScrollRange(1000);
                helpTexts["solid_adhension_velo"] = std::pair<UTFString, UTFString>(
                    _L("Adhesion velocity"),
                    _L("Below this value static friction laws apply, above it dynamic friction laws apply. "
                       "Value should be small, in the range of 0.1-0.4 . This velocity threshold is also used "
                       "by fluid dynamics so you should always define it. NEVER set it to 0."));
                ...
                e->eventEditTextChange += MyGUI::newDelegate(this, &FrictionSettings::event_edit_TextChange);
                t = p->createWidget<MyGUI::TextBox>("TextBox", lx, ly, 20, 20, MyGUI::Align::Default,
                                                    "solid_dynamic_friction_edited");
                lx += 20;
                h = p->createWidget<MyGUI::ScrollBar>("ScrollBarH", lx, ly, 60, 20, MyGUI::Align::Default,
                                                      "solid_dynamic_friction_scroll");
                lx += 65;
                h->eventScrollChangePosition += MyGUI::newDelegate(this, &FrictionSettings::event_scroll_value);
                h->setScrollRange(1000);
                helpTexts["solid_dynamic_friction"] = std::pair<UTFString, UTFString>(
                    _L("Dynamic friction coef"),
                    _L("Or sliding friction coef. It should be smaller than static friction coef. This parameter defines how "
                       "much "
                       "friction you'll have when sliding. Try to find some values for it from the net."));
                minMaxs["solid_dynamic_friction"] = std::pair<Real, Real>(0.1f, 1.5f);
                b = p->createWidget<MyGUI::Button>("Button", lx, ly, 20, 20, MyGUI::Align::Default,
                                                   "solid_dynamic_friction_help");
                lx += 20;
                b->eventMouseButtonClick += MyGUI::newDelegate(this, &FrictionSettings::event_btn_MouseButtonClick);
                b->setCaption("?");
                ...
                e->eventEditTextChange += MyGUI::newDelegate(this, &FrictionSettings::event_edit_TextChange);
                t = p->createWidget<MyGUI::TextBox>("TextBox", lx, ly, 20, 20, MyGUI::Align::Default,
                                                    "solid_hydrodynamic_edited");
                lx += 20;
                h = p->createWidget<MyGUI::ScrollBar>("ScrollBarH", lx, ly, 60, 20, MyGUI::Align::Default,
                                                      "solid_hydrodynamic_scroll");
                lx += 65;
                h->eventScrollChangePosition += MyGUI::newDelegate(this, &FrictionSettings::event_scroll_value);
                h->setScrollRange(1000);
                helpTexts["solid_hydrodynamic"] = std::pair<UTFString, UTFString>(
                    _L("Hydrodynamic friction coef"), _L("This friction defines the added friction that you'll feel from a "
                                                         "surface that has a little film of fluid on it. "
                                                         "It is kind of redundant with all the fluid physics below, but it is "
                                                         "here so as for experimentally validated "
                                                         "values from the net to be usable. If you decide that you'll simulate "
                                                         "the film of fluid with the more complex "
                                                         "fluid physics below, then just set this to 0."));
                ...
                lx += 20;
                h = p->createWidget<MyGUI::ScrollBar>("ScrollBarH", lx, ly, 60, 20, MyGUI::Align::Default,
                                                      "solid_stribeck_scroll");
                lx += 65;
                helpTexts["solid_stribeck"] = std::pair<UTFString, UTFString>(
                    _L("Stribeck velocity"),
                    _L("You'll either find stribeck velocity in the net, or the inverse (1/stribeck velocity) "
                       "of it described as 'stribeck coef'. It defines the shape of the dynamic friction curve. "
                       "Lets leave it at that. Just find some nice values for it from the net."));
                ...
                h->eventScrollChangePosition += MyGUI::newDelegate(this, &FrictionSettings::event_scroll_value);
                h->setScrollRange(1000);
                helpTexts["solid_alpha"] =
                    std::pair<UTFString, UTFString>(_L("Alpha"), _L("Its usual value is 2. But you can try others."));
                ...
                lx += 20;
                helpTexts["combo_fx"] = std::pair<UTFString, UTFString>(
                    _L("FX Type"), _L("The type of special effects that RoR will use to give the "
                                      "appearance of a surface. It doesn't affect the physics at all"));
                ...
                b->setCaption("?");
                helpTexts["fx_color"] =
                    std::pair<UTFString, UTFString>(_L("FX Colour"), _L("The color of RoR's special effects"));
            ...
            p  = win->createWidget<MyGUI::Widget>("PanelSkin", x, by, 370, 25, MyGUI::Align::Default);
            {
                ...
                lx += 20;
                h = p->createWidget<MyGUI::ScrollBar>("ScrollBarH", lx, ly, 60, 20, MyGUI::Align::Default,
                                                      "fluid_flowbeh_scroll");
                lx += 65;
                h->eventScrollChangePosition += MyGUI::newDelegate(this, &FrictionSettings::event_scroll_value);
                h->setScrollRange(1000);
                helpTexts["fluid_flowbeh"] = std::pair<UTFString, UTFString>(
                    _L("Flow behavior index"),
                    _L("If it is 1.0 then the fluid will behave like water. The lower you get from 1.0, the more like mud the "
                       "fluid will "
                       "behave, meaning that for small velocities the fluid will resist motion and for large velocities the "
                       "fluid will "
                       "not resist so much. The higher you get from 1.0 the more like sand the fluid will behave. The bigger the "
                       "velocity, the bigger the resistance of the fluid (try to hit sand hard it'll feel like stone)."));
                ...
                lx += 20;
                h = p->createWidget<MyGUI::ScrollBar>("ScrollBarH", lx, ly, 60, 20, MyGUI::Align::Default,
                                                      "fluid_flowcon_scroll");
                lx += 65;
                h->eventScrollChangePosition += MyGUI::newDelegate(this, &FrictionSettings::event_scroll_value);
                h->setScrollRange(1000);
                helpTexts["fluid_flowcon"] = std::pair<UTFString, UTFString>(
                    _L("Flow consistency"),
                    _L("Think of it as default fluid resistance. Behavior index above changes it at real time. "
                       "Useful values in practice are quite large."));
                ...
                lx += 20;
                h = p->createWidget<MyGUI::ScrollBar>("ScrollBarH", lx, ly, 60, 20, MyGUI::Align::Default,
                                                      "fluid_density_scroll");
                lx += 65;
                h->eventScrollChangePosition += MyGUI::newDelegate(this, &FrictionSettings::event_scroll_value);
                h->setScrollRange(1000);
                helpTexts["fluid_density"] = std::pair<UTFString, UTFString>(
                    _L("Fluid density"), _L("In mud (or sand) the resistance of the fluid described by the parameters above will "
                                            "stop you and so keep you "
                                            "from sinking. But for substances like water it isn't the drag that stops you from "
                                            "sinking. Its buoyancy. This "
                                            "parameter is here so as to keep you from sinking when you wish to simulate fluids "
                                            "with low drag (resistance). "
                                            "For fluids like mud or sand you can put it at 0, but it is best to keep it at some "
                                            "minimum value. For fluids "
                                            "with behavior index >=1 it will behave like you are in water. For fluids with "
                                            "behavior index <1 it'll behave "
                                            "like you are in mud."));
                ...
                e->eventEditTextChange += MyGUI::newDelegate(this, &FrictionSettings::event_edit_TextChange);
                t = p->createWidget<MyGUI::TextBox>("TextBox", lx, ly, 20, 20, MyGUI::Align::Default,
                                                    "fluid_drag_anisotropy_edited");
                lx += 20;
                h = p->createWidget<MyGUI::ScrollBar>("ScrollBarH", lx, ly, 60, 20, MyGUI::Align::Default,
                                                      "fluid_drag_anisotropy_scroll");
                lx += 65;
                h->eventScrollChangePosition += MyGUI::newDelegate(this, &FrictionSettings::event_scroll_value);
                h->setScrollRange(1000);
                helpTexts["fluid_drag_anisotropy"] = std::pair<UTFString, UTFString>(
                    _L("Drag anisotropy"), _L("This parameter is for making it easier(cheating) to get out from mud. To get "
                                              "stuck in real mud isn't fun at all, "
                                              "so this makes the mud push up. Ranges in this parameter are from 0 to 1 . If you "
                                              "set it at 1 then you'll get "
                                              "real mud. For values from 0 to 1, the behavior goes from real mud to easy mud "
                                              "depending on this parameter and "
                                              "the value of Adhesion velocity. For velocity 0 real mud it is. For velocity >= "
                                              "adhesion velocity easy mud it "
                                              "is."));
        ...
        void FrictionSettings::setActiveCol(ground_model_t *gm)
        {
            ...
            if (selected_gm == gm) updateControls(gm);
        }
        ...
        void FrictionSettings::event_btn_MouseButtonClick(MyGUI::WidgetPtr _sender)
        {
            ...
            if (name == "select_current_ground") { updateControls(active_gm); }
        ...
        void FrictionSettings::event_scroll_value(MyGUI::ScrollBar *_sender, size_t _value)
        {
            ...
            if (name.size() > 7 && name.substr(name.size() - 7, 7) == "_scroll")
            {
                ...
                if (e) e->setCaption(TOSTRING(rvalue));
        ...
        {
            if (_name == "close") this->SetVisible(false);
        }
