...
void FrictionSettings::Draw()
{
    ...
    if (ImGui::SliderFloat(_L("Solid ground level:"), &gm.solid_ground_level, 0.f, 200.f)) { dirty = true; }
    ...
    if (ImGui::SliderFloat(_L("Strength:"), &gm.strength, 0.f, 2.f)) { dirty = true; }
    ...
    if (ImGui::SliderFloat(_L("Static friction coef:"), &gm.ms, 0.1f, 2.f)) { dirty = true; }
    ...
    if (ImGui::SliderFloat(_L("Adhesion velocity:"), &gm.va, 0.1f, 5.f)) { dirty = true; }
    ...
    if (ImGui::SliderFloat(_L("Dynamic friction coef:"), &gm.mc, 0.1f, 1.5f)) { dirty = true; }
    ...
    if (ImGui::SliderFloat(_L("Hydrodynamic friction coef:"), &gm.t2, 0.f, 1.5f)) { dirty = true; }
    ...
    if (ImGui::SliderFloat(_L("Stribeck velocity:"), &gm.vs, 0.f, 1000.f)) { dirty = true; }
    ...
    if (ImGui::SliderFloat(_L("alpha:"), &gm.alpha, 0.f, 200.f)) { dirty = true; }
    this->DrawTooltip(_L("Alpha"), _L("Its usual value is 2. But you can try others."));

    ImGui::TextDisabled(_L("Fluid Settings"));

    if (ImGui::SliderFloat(_L("Flow behavior index:"), &gm.flow_behavior_index, -2.f, 2.f)) { dirty = true; }
    ...
    if (ImGui::SliderFloat(_L("Flow consistency:"), &gm.flow_consistency_index, 10.f, 100000.f)) { dirty = true; }
    ...
    if (ImGui::SliderFloat(_L("Fluid density:"), &gm.fluid_density, 10.f, 100000.f)) { dirty = true; }
    ...
    if (ImGui::SliderFloat(_L("Drag anisotropy:"), &gm.drag_anisotropy, 0.f, 1.f)) { dirty = true; }
