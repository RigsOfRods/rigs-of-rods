...
namespace RoR
{
    namespace GUI
    {
        ...
        ATTRIBUTE_CLASS_LAYOUT(ActorSpawnerReportWindowLayout,
                               "RigSpawnerReportWindow.layout"); // Keeping old name, the panel will be replaced by DearIMGUI soon
                                                                 // anyway ~ only_a_ptr, 02/2018
