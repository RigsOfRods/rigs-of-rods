...
void GameControls::Draw()
{
    ...
    if (m_tab == ControlsTab::AIRPLANE)
    {
        ...
        ImGui::NextColumn();
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_AIRBRAKES_FULL).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_AIRBRAKES_FULL).c_str(), shortcut1, "##shortcut1");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_AIRBRAKES_LESS).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_AIRBRAKES_LESS).c_str(), shortcut2, "##shortcut2");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_AIRBRAKES_MORE).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_AIRBRAKES_MORE).c_str(), shortcut3, "##shortcut3");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_AIRBRAKES_NONE).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_AIRBRAKES_NONE).c_str(), shortcut4, "##shortcut4");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_BRAKE).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_BRAKE).c_str(), shortcut5, "##shortcut5");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_ELEVATOR_DOWN).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_ELEVATOR_DOWN).c_str(), shortcut6, "##shortcut6");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_ELEVATOR_UP).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_ELEVATOR_UP).c_str(), shortcut7, "##shortcut7");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_FLAPS_FULL).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_FLAPS_FULL).c_str(), shortcut8, "##shortcut8");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_FLAPS_LESS).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_FLAPS_LESS).c_str(), shortcut9, "##shortcut9");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_FLAPS_MORE).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_FLAPS_MORE).c_str(), shortcut10, "##shortcut10");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_FLAPS_NONE).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_FLAPS_NONE).c_str(), shortcut11, "##shortcut11");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_PARKING_BRAKE).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_PARKING_BRAKE).c_str(), shortcut12, "##shortcut12");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_REVERSE).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_REVERSE).c_str(), shortcut13, "##shortcut13");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_RUDDER_LEFT).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_RUDDER_LEFT).c_str(), shortcut14, "##shortcut14");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_RUDDER_RIGHT).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_RUDDER_RIGHT).c_str(), shortcut15, "##shortcut15");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_STEER_LEFT).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_STEER_LEFT).c_str(), shortcut16, "##shortcut16");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_STEER_RIGHT).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_STEER_RIGHT).c_str(), shortcut17, "##shortcut17");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_THROTTLE_AXIS).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_THROTTLE_AXIS).c_str(), shortcut18, "##shortcut18");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_THROTTLE_DOWN).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_THROTTLE_DOWN).c_str(), shortcut19, "##shortcut19");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_THROTTLE_FULL).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_THROTTLE_FULL).c_str(), shortcut20, "##shortcut20");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_THROTTLE_NO).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_THROTTLE_NO).c_str(), shortcut21, "##shortcut21");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_THROTTLE_UP).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_THROTTLE_UP).c_str(), shortcut22, "##shortcut22");
        App::GetInputEngine()->EditInputConfig(App::GetInputEngine()->getEventCommand(EV_AIRPLANE_TOGGLE_ENGINES).c_str(), App::GetInputEngine()->eventIDToName(EV_AIRPLANE_TOGGLE_ENGINES).c_str(), shortcut23, "##shortcut23");
        ImGui::NextColumn();
        ImGui::AlignFirstTextHeightToWidgets();
