...
void SimActorStats::Draw(RoR::GfxActor* actorx)
{
    ...
    if (m_stat_health < 1.0f)
    {
        ...
        ImGui::TextColored(theme.value_blue_text_color, _L("Vehicle health: "));
        ImGui::SameLine();
        ImGui::Text("%.2f%%", value);
    }
    else if (m_stat_health >= 1.0f) //When this condition is true, it means that health is at 0% which means 100% of destruction.
    {
        ImGui::TextColored(theme.value_blue_text_color, _L("Vehicle destruction: "));
        ImGui::SameLine();
        ImGui::Text("100%%");
    }
    ...
    ImGui::TextColored(theme.value_blue_text_color, _L("Beam count: "));
    ImGui::SameLine();
    ...
    ImGui::TextColored(theme.value_blue_text_color, _L("Average stress: "));
    ImGui::SameLine();
    ...
    ImGui::TextColored(theme.value_blue_text_color, _L("Node count: "));
    ImGui::SameLine();
    ImGui::Text("%d (%s%d)", num_nodes, "wheels: ", num_wheelnodes);

    ImGui::TextColored(theme.value_blue_text_color, _L("Total mass: "));
    ImGui::SameLine();
    ...
    if ((actorx->GetAttributes().xa_has_engine) && (actorx->GetAttributes().xa_driveable == TRUCK))
    {
        ...
        ImGui::TextColored(theme.value_blue_text_color, _L("Engine RPM: "));
        ImGui::SameLine();
        ...
        ImGui::TextColored(theme.value_blue_text_color, _L("Drive ratio: "));
        ImGui::SameLine();
    ...
    else // Aircraft or boat
    {
        ...
        if (actorx->GetAttributes().xa_driveable == AIRPLANE)
        {
            ...
            {
                ImGui::TextColored(theme.value_blue_text_color, "%s #%d:", _L("Engine "), engine_num);
                ImGui::SameLine();
    ...
    ImGui::TextColored(theme.value_blue_text_color, _L("G-Forces:"));
