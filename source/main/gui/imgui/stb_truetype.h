...
extern "C"
{
    ...
    STBTT_DEF int stbtt_PackFontRanges(stbtt_pack_context *spc, unsigned char *fontdata, int font_index, stbtt_pack_range *ranges,
                                       int num_ranges);
...
static int stbtt__run_charstring(const stbtt_fontinfo *info, int glyph_index, stbtt__csctx *c)
{
    ...
    while (b.cursor < b.size)
    {
        ...
        default:
            ...
            // push immediate
            if (b0 == 255) { f = (float)stbtt__buf_get32(&b) / 0x10000; }
            else
            {
                stbtt__buf_skip(&b, -1);
