...
/*
 ...
 - 2019/06/14 (1.72) - removed redirecting functions/enums names that were marked obsolete in 1.51 (June 2017): ImGuiCol_Column*, ImGuiCond_*, IsItemHoveredRect(), IsPosHoveringAnyWindow(), IsMouseHoveringAnyWindow(), IsMouseHoveringWindow(), IMGUI_ONCE_UPON_A_FRAME. Grep this log for details and new names.
 ...
 - 2017/08/11 (1.51) - renamed ImGuiCond_Always to ImGuiCond_Always, ImGuiCond_Once to ImGuiCond_Once, ImGuiCond_FirstUseEver to ImGuiCond_FirstUseEver, ImGuiCond_Appearing to ImGuiCond_Appearing. Kept redirection enums (will obsolete).
 ...
 - 2015/02/27 (1.34) - renamed ImGuiSetCondition_*** to ImGuiCond_***, and _FirstUseThisSession becomes _Once.
