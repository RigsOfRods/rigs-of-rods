...
void WriteToTexture(const String& str, TexturePtr destTexture, Box destRectangle, Font* Reffont, const ColourValue& color, int fontSize, int fontDPI, char justify, bool wordwrap)
{
    using namespace Ogre;
