...
InputEvent eventInfo[] = {
    ...
    {"CHARACTER_CUSTOM_ACTION_01",    EV_CHARACTER_CUSTOM_ACTION_01,    "Keyboard EXPL+F1",             _LC("InputEvent", "character-specific action slot 1")},
    {"CHARACTER_CUSTOM_ACTION_02",    EV_CHARACTER_CUSTOM_ACTION_02,    "Keyboard EXPL+F2",             _LC("InputEvent", "character-specific action slot 2") },
    {"CHARACTER_CUSTOM_ACTION_03",    EV_CHARACTER_CUSTOM_ACTION_03,    "Keyboard EXPL+F3",             _LC("InputEvent", "character-specific action slot 3") },
    {"CHARACTER_CUSTOM_ACTION_04",    EV_CHARACTER_CUSTOM_ACTION_04,    "Keyboard EXPL+F4",             _LC("InputEvent", "character-specific action slot 4") },
    {"CHARACTER_CUSTOM_ACTION_05",    EV_CHARACTER_CUSTOM_ACTION_05,    "Keyboard EXPL+F5",             _LC("InputEvent", "character-specific action slot 5") },
    {"CHARACTER_CUSTOM_ACTION_06",    EV_CHARACTER_CUSTOM_ACTION_06,    "Keyboard EXPL+F6",             _LC("InputEvent", "character-specific action slot 6") },
    {"CHARACTER_CUSTOM_ACTION_07",    EV_CHARACTER_CUSTOM_ACTION_07,    "Keyboard EXPL+F7",             _LC("InputEvent", "character-specific action slot 7") },
    {"CHARACTER_CUSTOM_ACTION_08",    EV_CHARACTER_CUSTOM_ACTION_08,    "Keyboard EXPL+F8",             _LC("InputEvent", "character-specific action slot 8") },
    {"CHARACTER_CUSTOM_ACTION_09",    EV_CHARACTER_CUSTOM_ACTION_09,    "Keyboard EXPL+F9",             _LC("InputEvent", "character-specific action slot 9") },
    {"CHARACTER_CUSTOM_ACTION_10",    EV_CHARACTER_CUSTOM_ACTION_10,    "Keyboard EXPL+F10",            _LC("InputEvent", "character-specific action slot 10") },
    {"CHARACTER_CUSTOM_MODE_01",      EV_CHARACTER_CUSTOM_MODE_01,      "Keyboard EXPL+CTRL+1",         _LC("InputEvent", "character-specific mode slot 1")},
    {"CHARACTER_CUSTOM_MODE_02",      EV_CHARACTER_CUSTOM_MODE_02,      "Keyboard EXPL+CTRL+2",         _LC("InputEvent", "character-specific mode slot 2") },
    {"CHARACTER_CUSTOM_MODE_03",      EV_CHARACTER_CUSTOM_MODE_03,      "Keyboard EXPL+CTRL+3",         _LC("InputEvent", "character-specific mode slot 3") },
    {"CHARACTER_CUSTOM_MODE_04",      EV_CHARACTER_CUSTOM_MODE_04,      "Keyboard EXPL+CTRL+4",         _LC("InputEvent", "character-specific mode slot 4") },
    {"CHARACTER_CUSTOM_MODE_05",      EV_CHARACTER_CUSTOM_MODE_05,      "Keyboard EXPL+CTRL+5",         _LC("InputEvent", "character-specific mode slot 5") },
    {"CHARACTER_CUSTOM_MODE_06",      EV_CHARACTER_CUSTOM_MODE_06,      "Keyboard EXPL+CTRL+6",         _LC("InputEvent", "character-specific mode slot 6") },
    {"CHARACTER_CUSTOM_MODE_07",      EV_CHARACTER_CUSTOM_MODE_07,      "Keyboard EXPL+CTRL+7",         _LC("InputEvent", "character-specific mode slot 7") },
    {"CHARACTER_CUSTOM_MODE_08",      EV_CHARACTER_CUSTOM_MODE_08,      "Keyboard EXPL+CTRL+8",         _LC("InputEvent", "character-specific mode slot 8") },
    {"CHARACTER_CUSTOM_MODE_09",      EV_CHARACTER_CUSTOM_MODE_09,      "Keyboard EXPL+CTRL+9",         _LC("InputEvent", "character-specific mode slot 9") },
    {"CHARACTER_CUSTOM_MODE_10",      EV_CHARACTER_CUSTOM_MODE_10,      "Keyboard EXPL+CTRL+0",         _LC("InputEvent", "character-specific mode slot 10") },
