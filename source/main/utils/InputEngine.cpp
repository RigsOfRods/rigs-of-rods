...
eventInfo_t eventInfo[] = {
    {"AIRPLANE_STEER_RIGHT", EV_AIRPLANE_STEER_RIGHT, "Keyboard RIGHT", _L("steer right")},
    {"AIRPLANE_BRAKE", EV_AIRPLANE_BRAKE, "Keyboard B", _L("normal brake for an aircraft")},
    {"AIRPLANE_ELEVATOR_DOWN", EV_AIRPLANE_ELEVATOR_DOWN, "Keyboard DOWN", _L("pull the elevator down in an aircraft.")},
    {"AIRPLANE_ELEVATOR_UP", EV_AIRPLANE_ELEVATOR_UP, "Keyboard UP", _L("pull the elevator up in an aircraft.")},
    {"AIRPLANE_FLAPS_FULL", EV_AIRPLANE_FLAPS_FULL, "Keyboard CTRL+2", _L("full flaps in an aircraft.")},
    {"AIRPLANE_FLAPS_LESS", EV_AIRPLANE_FLAPS_LESS, "Keyboard EXPL+1", _L("one step less flaps.")},
    {"AIRPLANE_FLAPS_MORE", EV_AIRPLANE_FLAPS_MORE, "Keyboard EXPL+2", _L("one step more flaps.")},
    {"AIRPLANE_FLAPS_NONE", EV_AIRPLANE_FLAPS_NONE, "Keyboard CTRL+1", _L("no flaps.")},
    {"AIRPLANE_PARKING_BRAKE", EV_AIRPLANE_PARKING_BRAKE, "Keyboard P", _L("airplane parking brake.")

    },
    {"AIRPLANE_REVERSE", EV_AIRPLANE_REVERSE, "Keyboard R", _L("reverse the turboprops")},
    {"AIRPLANE_RUDDER_LEFT", EV_AIRPLANE_RUDDER_LEFT, "Keyboard Z", _L("rudder left")},
    {"AIRPLANE_RUDDER_RIGHT", EV_AIRPLANE_RUDDER_RIGHT, "Keyboard X", _L("rudder right")},
    {"AIRPLANE_STEER_LEFT", EV_AIRPLANE_STEER_LEFT, "Keyboard LEFT", _L("steer left")},
    {"AIRPLANE_STEER_RIGHT", EV_AIRPLANE_STEER_RIGHT, "Keyboard RIGHT", _L("steer right")},
    {"AIRPLANE_THROTTLE_AXIS", EV_AIRPLANE_THROTTLE_AXIS, "None",
     _L("throttle axis. Only use this if you have fitting hardware :) (i.e. a Slider)")},
    {"AIRPLANE_THROTTLE_DOWN", EV_AIRPLANE_THROTTLE_DOWN, "Keyboard EXPL+PGDOWN", _L("decreases the airplane thrust")},
    {"AIRPLANE_THROTTLE_FULL", EV_AIRPLANE_THROTTLE_FULL, "Keyboard CTRL+PGUP", _L("full thrust")},
    {"AIRPLANE_THROTTLE_NO", EV_AIRPLANE_THROTTLE_NO, "Keyboard CTRL+PGDOWN", _L("no thrust")},
    {"AIRPLANE_THROTTLE_UP", EV_AIRPLANE_THROTTLE_UP, "Keyboard EXPL+PGUP", _L("increase the airplane thrust")},
    {"AIRPLANE_TOGGLE_ENGINES", EV_AIRPLANE_TOGGLE_ENGINES, "Keyboard CTRL+HOME", _L("switch all engines on / off")},
    {"BOAT_CENTER_RUDDER", EV_BOAT_CENTER_RUDDER, "Keyboard PGDOWN", _L("center the rudder")},
    {"BOAT_REVERSE", EV_BOAT_REVERSE, "Keyboard PGUP", _L("no thrust")},
    {"BOAT_STEER_LEFT", EV_BOAT_STEER_LEFT, "Keyboard LEFT", _L("steer left a step")},
    {"BOAT_STEER_LEFT_AXIS", EV_BOAT_STEER_LEFT_AXIS, "None", _L("steer left (analog value!)")},
    {"BOAT_STEER_RIGHT", EV_BOAT_STEER_RIGHT, "Keyboard RIGHT", _L("steer right a step")},
    {"BOAT_STEER_RIGHT_AXIS", EV_BOAT_STEER_RIGHT_AXIS, "None", _L("steer right (analog value!)")},
    {"BOAT_THROTTLE_AXIS", EV_BOAT_THROTTLE_AXIS, "None",
     _L("throttle axis. Only use this if you have fitting hardware :) (i.e. a Slider)")},
    {"BOAT_THROTTLE_DOWN", EV_BOAT_THROTTLE_DOWN, "Keyboard DOWN", _L("decrease throttle")},
    {"BOAT_THROTTLE_UP", EV_BOAT_THROTTLE_UP, "Keyboard UP", _L("increase throttle")},
    {"SKY_DECREASE_TIME", EV_SKY_DECREASE_TIME, "Keyboard EXPL+SUBTRACT", _L("decrease day-time")},
    {"SKY_DECREASE_TIME_FAST", EV_SKY_DECREASE_TIME_FAST, "Keyboard SHIFT+SUBTRACT", _L("decrease day-time a lot faster")},
    {"SKY_INCREASE_TIME", EV_SKY_INCREASE_TIME, "Keyboard EXPL+ADD", _L("increase day-time")},
    {"SKY_INCREASE_TIME_FAST", EV_SKY_INCREASE_TIME_FAST, "Keyboard SHIFT+ADD", _L("increase day-time a lot faster")},
    {"CAMERA_CHANGE", EV_CAMERA_CHANGE, "Keyboard EXPL+C", _L("change camera mode")},
    {"CAMERA_LOOKBACK", EV_CAMERA_LOOKBACK, "Keyboard NUMPAD1", _L("look back (toggles between normal and lookback)")},
    {"CAMERA_RESET", EV_CAMERA_RESET, "Keyboard NUMPAD5", _L("reset the camera position")},
    {"CAMERA_ROTATE_DOWN", EV_CAMERA_ROTATE_DOWN, "Keyboard NUMPAD2", _L("rotate camera down")},
    {"CAMERA_ROTATE_LEFT", EV_CAMERA_ROTATE_LEFT, "Keyboard NUMPAD4", _L("rotate camera left")},
    {"CAMERA_ROTATE_RIGHT", EV_CAMERA_ROTATE_RIGHT, "Keyboard NUMPAD6", _L("rotate camera right")},
    {"CAMERA_ROTATE_UP", EV_CAMERA_ROTATE_UP, "Keyboard NUMPAD8", _L("rotate camera up")},
    {"CAMERA_ZOOM_IN", EV_CAMERA_ZOOM_IN, "Keyboard EXPL+NUMPAD9", _L("zoom camera in")},
    {"CAMERA_ZOOM_IN_FAST", EV_CAMERA_ZOOM_IN_FAST, "Keyboard SHIFT+NUMPAD9", _L("zoom camera in faster")},
    {"CAMERA_ZOOM_OUT", EV_CAMERA_ZOOM_OUT, "Keyboard EXPL+NUMPAD3", _L("zoom camera out")},
    {"CAMERA_ZOOM_OUT_FAST", EV_CAMERA_ZOOM_OUT_FAST, "Keyboard SHIFT+NUMPAD3", _L("zoom camera out faster")},
    {"CHARACTER_BACKWARDS", EV_CHARACTER_BACKWARDS, "Keyboard S", _L("step backwards with the character")},
    {"CHARACTER_FORWARD", EV_CHARACTER_FORWARD, "Keyboard W", _L("step forward with the character")},
    {"CHARACTER_JUMP", EV_CHARACTER_JUMP, "Keyboard SPACE", _L("let the character jump")},
    {"CHARACTER_LEFT", EV_CHARACTER_LEFT, "Keyboard LEFT", _L("rotate character left")},
    {"CHARACTER_RIGHT", EV_CHARACTER_RIGHT, "Keyboard RIGHT", _L("rotate character right")},
    {"CHARACTER_RUN", EV_CHARACTER_RUN, "Keyboard SHIFT+W", _L("let the character run")},
    {"CHARACTER_SIDESTEP_LEFT", EV_CHARACTER_SIDESTEP_LEFT, "Keyboard A", _L("sidestep to the left")},
    {"CHARACTER_SIDESTEP_RIGHT", EV_CHARACTER_SIDESTEP_RIGHT, "Keyboard D", _L("sidestep to the right")},
    {"COMMANDS_01", EV_COMMANDS_01, "Keyboard EXPL+F1", _L("Command 1")},
    {"COMMANDS_02", EV_COMMANDS_02, "Keyboard EXPL+F2", _L("Command 2")},
    {"COMMANDS_03", EV_COMMANDS_03, "Keyboard EXPL+F3", _L("Command 3")},
    {"COMMANDS_04", EV_COMMANDS_04, "Keyboard EXPL+F4", _L("Command 4")},
    {"COMMANDS_05", EV_COMMANDS_05, "Keyboard EXPL+F5", _L("Command 5")},
    {"COMMANDS_06", EV_COMMANDS_06, "Keyboard EXPL+F6", _L("Command 6")},
    {"COMMANDS_07", EV_COMMANDS_07, "Keyboard EXPL+F7", _L("Command 7")},
    {"COMMANDS_08", EV_COMMANDS_08, "Keyboard EXPL+F8", _L("Command 8")},
    {"COMMANDS_09", EV_COMMANDS_09, "Keyboard EXPL+F9", _L("Command 9")},
    {"COMMANDS_10", EV_COMMANDS_10, "Keyboard EXPL+F10", _L("Command 10")},
    {"COMMANDS_11", EV_COMMANDS_11, "Keyboard EXPL+F11", _L("Command 11")},
    {"COMMANDS_12", EV_COMMANDS_12, "Keyboard EXPL+F12", _L("Command 12")},
    {"COMMANDS_13", EV_COMMANDS_13, "Keyboard EXPL+CTRL+F1", _L("Command 13")},
    {"COMMANDS_14", EV_COMMANDS_14, "Keyboard EXPL+CTRL+F2", _L("Command 14")},
    {"COMMANDS_15", EV_COMMANDS_15, "Keyboard EXPL+CTRL+F3", _L("Command 15")},
    {"COMMANDS_16", EV_COMMANDS_16, "Keyboard EXPL+CTRL+F4", _L("Command 16")},
    {"COMMANDS_17", EV_COMMANDS_17, "Keyboard EXPL+CTRL+F5", _L("Command 17")},
    {"COMMANDS_18", EV_COMMANDS_18, "Keyboard EXPL+CTRL+F6", _L("Command 18")},
    {"COMMANDS_19", EV_COMMANDS_19, "Keyboard EXPL+CTRL+F7", _L("Command 19")},
    {"COMMANDS_20", EV_COMMANDS_20, "Keyboard EXPL+CTRL+F8", _L("Command 20")},
    {"COMMANDS_21", EV_COMMANDS_21, "Keyboard EXPL+CTRL+F9", _L("Command 21")},
    {"COMMANDS_22", EV_COMMANDS_22, "Keyboard EXPL+CTRL+F10", _L("Command 22")},
    {"COMMANDS_23", EV_COMMANDS_23, "Keyboard EXPL+CTRL+F11", _L("Command 23")},
    {"COMMANDS_24", EV_COMMANDS_24, "Keyboard EXPL+CTRL+F12", _L("Command 24")},
    {"COMMANDS_25", EV_COMMANDS_25, "Keyboard EXPL+SHIFT+F1", _L("Command 25")},
    {"COMMANDS_26", EV_COMMANDS_26, "Keyboard EXPL+SHIFT+F2", _L("Command 26")},
    {"COMMANDS_27", EV_COMMANDS_27, "Keyboard EXPL+SHIFT+F3", _L("Command 27")},
    {"COMMANDS_28", EV_COMMANDS_28, "Keyboard EXPL+SHIFT+F4", _L("Command 28")},
    {"COMMANDS_29", EV_COMMANDS_29, "Keyboard EXPL+SHIFT+F5", _L("Command 29")},
    {"COMMANDS_30", EV_COMMANDS_30, "Keyboard EXPL+SHIFT+F6", _L("Command 30")},
    {"COMMANDS_31", EV_COMMANDS_31, "Keyboard EXPL+SHIFT+F7", _L("Command 31")},
    {"COMMANDS_32", EV_COMMANDS_32, "Keyboard EXPL+SHIFT+F8", _L("Command 32")},
    {"COMMANDS_33", EV_COMMANDS_33, "Keyboard EXPL+SHIFT+F9", _L("Command 33")},
    {"COMMANDS_34", EV_COMMANDS_34, "Keyboard EXPL+SHIFT+F10", _L("Command 34")},
    {"COMMANDS_35", EV_COMMANDS_35, "Keyboard EXPL+SHIFT+F11", _L("Command 35")},
    {"COMMANDS_36", EV_COMMANDS_36, "Keyboard EXPL+SHIFT+F12", _L("Command 36")},
    {"COMMANDS_37", EV_COMMANDS_37, "Keyboard EXPL+ALT+F1", _L("Command 37")},
    {"COMMANDS_38", EV_COMMANDS_38, "Keyboard EXPL+ALT+F2", _L("Command 38")},
    {"COMMANDS_39", EV_COMMANDS_39, "Keyboard EXPL+ALT+F3", _L("Command 39")},
    {"COMMANDS_40", EV_COMMANDS_40, "Keyboard EXPL+ALT+F4", _L("Command 40")},
    {"COMMANDS_41", EV_COMMANDS_41, "Keyboard EXPL+ALT+F5", _L("Command 41")},
    {"COMMANDS_42", EV_COMMANDS_42, "Keyboard EXPL+ALT+F6", _L("Command 42")},
    {"COMMANDS_43", EV_COMMANDS_43, "Keyboard EXPL+ALT+F7", _L("Command 43")},
    {"COMMANDS_44", EV_COMMANDS_44, "Keyboard EXPL+ALT+F8", _L("Command 44")},
    {"COMMANDS_45", EV_COMMANDS_45, "Keyboard EXPL+ALT+F9", _L("Command 45")},
    {"COMMANDS_46", EV_COMMANDS_46, "Keyboard EXPL+ALT+F10", _L("Command 46")},
    {"COMMANDS_47", EV_COMMANDS_47, "Keyboard EXPL+ALT+F11", _L("Command 47")},
    {"COMMANDS_48", EV_COMMANDS_48, "Keyboard EXPL+ALT+F12", _L("Command 48")},
    {"COMMANDS_49", EV_COMMANDS_49, "Keyboard EXPL+CTRL+SHIFT+F1", _L("Command 49")},
    {"COMMANDS_50", EV_COMMANDS_50, "Keyboard EXPL+CTRL+SHIFT+F2", _L("Command 50")},
    {"COMMANDS_51", EV_COMMANDS_51, "Keyboard EXPL+CTRL+SHIFT+F3", _L("Command 51")},
    {"COMMANDS_52", EV_COMMANDS_52, "Keyboard EXPL+CTRL+SHIFT+F4", _L("Command 52")},
    {"COMMANDS_53", EV_COMMANDS_53, "Keyboard EXPL+CTRL+SHIFT+F5", _L("Command 53")},
    {"COMMANDS_54", EV_COMMANDS_54, "Keyboard EXPL+CTRL+SHIFT+F6", _L("Command 54")},
    {"COMMANDS_55", EV_COMMANDS_55, "Keyboard EXPL+CTRL+SHIFT+F7", _L("Command 55")},
    {"COMMANDS_56", EV_COMMANDS_56, "Keyboard EXPL+CTRL+SHIFT+F8", _L("Command 56")},
    {"COMMANDS_57", EV_COMMANDS_57, "Keyboard EXPL+CTRL+SHIFT+F9", _L("Command 57")},
    {"COMMANDS_58", EV_COMMANDS_58, "Keyboard EXPL+CTRL+SHIFT+F10", _L("Command 58")},
    {"COMMANDS_59", EV_COMMANDS_59, "Keyboard EXPL+CTRL+SHIFT+F11", _L("Command 59")},
    {"COMMANDS_60", EV_COMMANDS_60, "Keyboard EXPL+CTRL+SHIFT+F12", _L("Command 60")},
    {"COMMANDS_61", EV_COMMANDS_61, "Keyboard EXPL+CTRL+ALT+F1", _L("Command 61")},
    {"COMMANDS_62", EV_COMMANDS_62, "Keyboard EXPL+CTRL+ALT+F2", _L("Command 62")},
    {"COMMANDS_63", EV_COMMANDS_63, "Keyboard EXPL+CTRL+ALT+F3", _L("Command 63")},
    {"COMMANDS_64", EV_COMMANDS_64, "Keyboard EXPL+CTRL+ALT+F4", _L("Command 64")},
    {"COMMANDS_65", EV_COMMANDS_65, "Keyboard EXPL+CTRL+ALT+F5", _L("Command 65")},
    {"COMMANDS_66", EV_COMMANDS_66, "Keyboard EXPL+CTRL+ALT+F6", _L("Command 66")},
    {"COMMANDS_67", EV_COMMANDS_67, "Keyboard EXPL+CTRL+ALT+F7", _L("Command 67")},
    {"COMMANDS_68", EV_COMMANDS_68, "Keyboard EXPL+CTRL+ALT+F8", _L("Command 68")},
    {"COMMANDS_69", EV_COMMANDS_69, "Keyboard EXPL+CTRL+ALT+F9", _L("Command 69")},
    {"COMMANDS_70", EV_COMMANDS_70, "Keyboard EXPL+CTRL+ALT+F10", _L("Command 70")},
    {"COMMANDS_71", EV_COMMANDS_71, "Keyboard EXPL+CTRL+ALT+F11", _L("Command 71")},
    {"COMMANDS_72", EV_COMMANDS_72, "Keyboard EXPL+CTRL+ALT+F12", _L("Command 72")},
    {"COMMANDS_73", EV_COMMANDS_73, "Keyboard EXPL+CTRL+SHIFT+ALT+F1", _L("Command 73")},
    {"COMMANDS_74", EV_COMMANDS_74, "Keyboard EXPL+CTRL+SHIFT+ALT+F2", _L("Command 74")},
    {"COMMANDS_75", EV_COMMANDS_75, "Keyboard EXPL+CTRL+SHIFT+ALT+F3", _L("Command 75")},
    {"COMMANDS_76", EV_COMMANDS_76, "Keyboard EXPL+CTRL+SHIFT+ALT+F4", _L("Command 76")},
    {"COMMANDS_77", EV_COMMANDS_77, "Keyboard EXPL+CTRL+SHIFT+ALT+F5", _L("Command 77")},
    {"COMMANDS_78", EV_COMMANDS_78, "Keyboard EXPL+CTRL+SHIFT+ALT+F6", _L("Command 78")},
    {"COMMANDS_79", EV_COMMANDS_79, "Keyboard EXPL+CTRL+SHIFT+ALT+F7", _L("Command 79")},
    {"COMMANDS_80", EV_COMMANDS_80, "Keyboard EXPL+CTRL+SHIFT+ALT+F8", _L("Command 80")},
    {"COMMANDS_81", EV_COMMANDS_81, "Keyboard EXPL+CTRL+SHIFT+ALT+F9", _L("Command 81")},
    {"COMMANDS_82", EV_COMMANDS_82, "Keyboard EXPL+CTRL+SHIFT+ALT+F10", _L("Command 82")},
    {"COMMANDS_83", EV_COMMANDS_83, "Keyboard EXPL+CTRL+SHIFT+ALT+F11", _L("Command 83")},
    {"COMMANDS_84", EV_COMMANDS_84, "Keyboard EXPL+CTRL+SHIFT+ALT+F12", _L("Command 84")},
    {"COMMON_ACCELERATE_SIMULATION", EV_COMMON_ACCELERATE_SIMULATION, "Keyboard CTRL+EQUALS", _L("accelerate the simulation")},
    {"COMMON_DECELERATE_SIMULATION", EV_COMMON_DECELERATE_SIMULATION, "Keyboard SHIFT+EQUALS", _L("decelerate the simulation")},
    {"COMMON_RESET_SIMULATION_PACE", EV_COMMON_RESET_SIMULATION_PACE, "Keyboard BACKSLASH", _L("reset the simulation pace")},
    {"COMMON_CONSOLE_TOGGLE", EV_COMMON_CONSOLE_TOGGLE, "Keyboard EXPL+GRAVE", _L("show / hide the console")},
    {"COMMON_ENTER_CHATMODE", EV_COMMON_ENTER_CHATMODE, "Keyboard Y", _L("enter the chat")},
    {"COMMON_SEND_CHAT", EV_COMMON_SEND_CHAT, "Keyboard RETURN", _L("sends the entered text")},
    {"COMMON_ENTER_OR_EXIT_TRUCK", EV_COMMON_ENTER_OR_EXIT_TRUCK, "Keyboard RETURN", _L("enter or exit a truck")},
    {"COMMON_ENTER_NEXT_TRUCK", EV_COMMON_ENTER_NEXT_TRUCK, "Keyboard EXPL+CTRL+RBRACKET", _L("enter next truck")},
    {"COMMON_ENTER_PREVIOUS_TRUCK", EV_COMMON_ENTER_PREVIOUS_TRUCK, "Keyboard EXPL+CTRL+LBRACKET", _L("enter previous truck")},
    {"COMMON_REMOVE_CURRENT_TRUCK", EV_COMMON_REMOVE_CURRENT_TRUCK, "Keyboard EXPL+CTRL+DELETE", _L("remove current truck")},
    {"COMMON_RESPAWN_LAST_TRUCK", EV_COMMON_RESPAWN_LAST_TRUCK, "Keyboard EXPL+CTRL+PERIOD", _L("respawn last truck")},
    {"COMMON_HIDE_GUI", EV_COMMON_HIDE_GUI, "Keyboard EXPL+U", _L("hide all GUI elements")},
    {"COMMON_TOGGLE_DASHBOARD", EV_COMMON_TOGGLE_DASHBOARD, "Keyboard EXPL+CTRL+U", _L("display or hide the dashboard overlay")},
    {"COMMON_LOCK", EV_COMMON_LOCK, "Keyboard EXPL+L", _L("connect hook node to a node in close proximity")},
    {"COMMON_AUTOLOCK", EV_COMMON_AUTOLOCK, "Keyboard EXPL+ALT+L", _L("unlock autolock hook node")},
    {"COMMON_ROPELOCK", EV_COMMON_ROPELOCK, "Keyboard EXPL+CTRL+L", _L("connect a rope to a node in close proximity")},
    {"COMMON_OUTPUT_POSITION", EV_COMMON_OUTPUT_POSITION, "Keyboard H",
     _L("write current position to log (you can open the logfile and reuse the position)")},
    {"COMMON_GET_NEW_VEHICLE", EV_COMMON_GET_NEW_VEHICLE, "Keyboard EXPL+CTRL+G", _L("get new vehicle")},
    {"COMMON_PRESSURE_LESS", EV_COMMON_PRESSURE_LESS, "Keyboard LBRACKET",
     _L("decrease tire pressure (note: only very few trucks support this)")},
    {"COMMON_PRESSURE_MORE", EV_COMMON_PRESSURE_MORE, "Keyboard RBRACKET",
     _L("increase tire pressure (note: only very few trucks support this)")},
    {"COMMON_QUIT_GAME", EV_COMMON_QUIT_GAME, "Keyboard EXPL+ESCAPE", _L("exit the game")},
    {"COMMON_QUICKLOAD", EV_COMMON_QUICKLOAD, "Keyboard MULTIPLY", _L("quickload scene")},
    {"COMMON_QUICKSAVE", EV_COMMON_QUICKSAVE, "Keyboard DIVIDE", _L("quicksave scene")},
    {"COMMON_REPAIR_TRUCK", EV_COMMON_REPAIR_TRUCK, "Keyboard BACK", _L("repair truck")},
    {"COMMON_RESCUE_TRUCK", EV_COMMON_RESCUE_TRUCK, "Keyboard EXPL+R", _L("teleport to rescue truck")},
    {"COMMON_RESET_TRUCK", EV_COMMON_RESET_TRUCK, "Keyboard I", _L("reset truck to original starting position")},
    {"COMMON_TOGGLE_RESET_MODE", EV_COMMON_TOGGLE_RESET_MODE, "Keyboard EXPL+APOSTROPHE", _L("toggle reset mode")},
    {"COMMON_SCREENSHOT", EV_COMMON_SCREENSHOT, "Keyboard EXPL+SYSRQ", _L("take a screenshot")},
    {"COMMON_SCREENSHOT_BIG", EV_COMMON_SCREENSHOT_BIG, "Keyboard EXPL+CTRL+SYSRQ",
     _L("take a big screenshot (3 times the screen size)")},
    {"COMMON_SAVE_TERRAIN", EV_COMMON_SAVE_TERRAIN, "Keyboard EXPL+ALT+SHIF+CTRL+M",
     _L("save the currently loaded terrain to a mesh file")},
    {"COMMON_SECURE_LOAD", EV_COMMON_SECURE_LOAD, "Keyboard O", _L("tie a load to the truck")},
    {"COMMON_TOGGLE_DEBUG_VIEW", EV_COMMON_TOGGLE_DEBUG_VIEW, "Keyboard EXPL+K", _L("toggle debug view")},
    {"COMMON_CYCLE_DEBUG_VIEWS", EV_COMMON_CYCLE_DEBUG_VIEWS, "Keyboard EXPL+CTRL+K", _L("cycle debug views")},
    {"COMMON_TOGGLE_TERRAIN_EDITOR", EV_COMMON_TOGGLE_TERRAIN_EDITOR, "Keyboard EXPL+SHIFT+Y", _L("toggle terrain editor")},
    {"COMMON_TOGGLE_CUSTOM_PARTICLES", EV_COMMON_TOGGLE_CUSTOM_PARTICLES, "Keyboard G", _L("toggle particle cannon")},
    {"COMMON_TOGGLE_MAT_DEBUG", EV_COMMON_TOGGLE_MAT_DEBUG, "", _L("debug purpose - dont use")},
    {"COMMON_TOGGLE_RENDER_MODE", EV_COMMON_TOGGLE_RENDER_MODE, "Keyboard E",
     _L("toggle render mode (solid, wireframe and points)")},
    {"COMMON_TOGGLE_REPLAY_MODE", EV_COMMON_TOGGLE_REPLAY_MODE, "Keyboard EXPL+CTRL+J", _L("enable or disable replay mode")},
    {"COMMON_TOGGLE_PHYSICS", EV_COMMON_TOGGLE_PHYSICS, "Keyboard EXPL+J", _L("enable or disable physics")},
    {"COMMON_TOGGLE_STATS", EV_COMMON_TOGGLE_STATS, "Keyboard EXPL+F", _L("toggle Ogre statistics (FPS etc.)")},
    {"COMMON_TOGGLE_TRUCK_BEACONS", EV_COMMON_TOGGLE_TRUCK_BEACONS, "Keyboard M", _L("toggle truck beacons")},
    {"COMMON_TOGGLE_TRUCK_LIGHTS", EV_COMMON_TOGGLE_TRUCK_LIGHTS, "Keyboard N", _L("toggle truck front lights")},
    {"COMMON_TRUCK_INFO", EV_COMMON_TRUCK_INFO, "Keyboard EXPL+T", _L("toggle truck HUD")},
    {"COMMON_TRUCK_DESCRIPTION", EV_COMMON_TRUCK_DESCRIPTION, "Keyboard EXPL+CTRL+T", _L("toggle truck description")},
    {"COMMON_FOV_LESS", EV_COMMON_FOV_LESS, "Keyboard EXPL+NUMPAD7", _L("decreases the current FOV value")},
    {"COMMON_FOV_MORE", EV_COMMON_FOV_MORE, "Keyboard EXPL+CTRL+NUMPAD7", _L("increase the current FOV value")},
    {"COMMON_FOV_RESET", EV_COMMON_FOV_RESET, "Keyboard EXPL+SHIFT+NUMPAD7", _L("reset the FOV value")},
    {"GRASS_LESS", EV_GRASS_LESS, "", _L("EXPERIMENTAL: remove some grass")},
    {"GRASS_MORE", EV_GRASS_MORE, "", _L("EXPERIMENTAL: add some grass")},
    {"GRASS_MOST", EV_GRASS_MOST, "", _L("EXPERIMENTAL: set maximum amount of grass")},
    {"GRASS_NONE", EV_GRASS_NONE, "", _L("EXPERIMENTAL: remove grass completely")},
    {"GRASS_SAVE", EV_GRASS_SAVE, "", _L("EXPERIMENTAL: save changes to the grass density image")},
    {"MENU_DOWN", EV_MENU_DOWN, "Keyboard DOWN", _L("select next element in current category")},
    {"MENU_LEFT", EV_MENU_LEFT, "Keyboard LEFT", _L("select previous category")},
    {"MENU_RIGHT", EV_MENU_RIGHT, "Keyboard RIGHT", _L("select next category")},
    {"MENU_SELECT", EV_MENU_SELECT, "Keyboard EXPL+RETURN", _L("select focussed item and close menu")},
    {"MENU_UP", EV_MENU_UP, "Keyboard UP", _L("select previous element in current category")},
    {"SURVEY_MAP_TOGGLE_ICONS", EV_SURVEY_MAP_TOGGLE_ICONS, "Keyboard EXPL+CTRL+SHIFT+ALT+TAB", _L("toggle map icons")},
    {"SURVEY_MAP_TOGGLE", EV_SURVEY_MAP_TOGGLE, "Keyboard EXPL+CTRL+SHIFT+TAB", _L("toggle map")},
    {"SURVEY_MAP_CYCLE", EV_SURVEY_MAP_CYCLE, "Keyboard EXPL+TAB", _L("cycle map modes")},
    {"SURVEY_MAP_ZOOM_IN", EV_SURVEY_MAP_ZOOM_IN, "Keyboard EXPL+CTRL+TAB", _L("zoom in")},
    {"SURVEY_MAP_ZOOM_OUT", EV_SURVEY_MAP_ZOOM_OUT, "Keyboard EXPL+SHIFT+TAB", _L("zoom out")},
    {"TRUCK_ACCELERATE", EV_TRUCK_ACCELERATE, "Keyboard UP", _L("accelerate the truck")},
    {"TRUCK_ACCELERATE_MODIFIER_25", EV_TRUCK_ACCELERATE_MODIFIER_25, "Keyboard ALT+UP",
     _L("accelerate with 25 percent pedal input")},
    {"TRUCK_ACCELERATE_MODIFIER_50", EV_TRUCK_ACCELERATE_MODIFIER_50, "Keyboard CTRL+UP",
     _L("accelerate with 50 percent pedal input")},
    {"TRUCK_AUTOSHIFT_DOWN", EV_TRUCK_AUTOSHIFT_DOWN, "Keyboard PGDOWN", _L("shift automatic transmission one gear down")},
    {"TRUCK_AUTOSHIFT_UP", EV_TRUCK_AUTOSHIFT_UP, "Keyboard PGUP", _L("shift automatic transmission one gear up")},
    {"TRUCK_BLINK_LEFT", EV_TRUCK_BLINK_LEFT, "Keyboard COMMA", _L("toggle left direction indicator (blinker)")},
    {"TRUCK_BLINK_RIGHT", EV_TRUCK_BLINK_RIGHT, "Keyboard PERIOD", _L("toggle right direction indicator (blinker)")},
    {"TRUCK_BLINK_WARN", EV_TRUCK_BLINK_WARN, "Keyboard MINUS", _L("toggle all direction indicators")},
    {"TRUCK_BRAKE", EV_TRUCK_BRAKE, "Keyboard DOWN", _L("brake")},
    {"TRUCK_BRAKE_MODIFIER_25", EV_TRUCK_BRAKE_MODIFIER_25, "Keyboard ALT+DOWN", _L("brake with 25 percent pedal input")},
    {"TRUCK_BRAKE_MODIFIER_50", EV_TRUCK_BRAKE_MODIFIER_50, "Keyboard CTRL+DOWN", _L("brake with 50 percent pedal input")},
    {"TRUCK_HORN", EV_TRUCK_HORN, "Keyboard H", _L("truck horn")},
    {"TRUCK_LIGHTTOGGLE1", EV_TRUCK_LIGHTTOGGLE01, "Keyboard EXPL+CTRL+1", _L("toggle custom light 1")},
    {"TRUCK_LIGHTTOGGLE2", EV_TRUCK_LIGHTTOGGLE02, "Keyboard EXPL+CTRL+2", _L("toggle custom light 2")},
    {"TRUCK_LIGHTTOGGLE3", EV_TRUCK_LIGHTTOGGLE03, "Keyboard EXPL+CTRL+3", _L("toggle custom light 3")},
    {"TRUCK_LIGHTTOGGLE4", EV_TRUCK_LIGHTTOGGLE04, "Keyboard EXPL+CTRL+4", _L("toggle custom light 4")},
    {"TRUCK_LIGHTTOGGLE5", EV_TRUCK_LIGHTTOGGLE05, "Keyboard EXPL+CTRL+5", _L("toggle custom light 5")},
    {"TRUCK_LIGHTTOGGLE6", EV_TRUCK_LIGHTTOGGLE06, "Keyboard EXPL+CTRL+6", _L("toggle custom light 6")},
    {"TRUCK_LIGHTTOGGLE7", EV_TRUCK_LIGHTTOGGLE07, "Keyboard EXPL+CTRL+7", _L("toggle custom light 7")},
    {"TRUCK_LIGHTTOGGLE8", EV_TRUCK_LIGHTTOGGLE08, "Keyboard EXPL+CTRL+8", _L("toggle custom light 8")},
    {"TRUCK_LIGHTTOGGLE9", EV_TRUCK_LIGHTTOGGLE09, "Keyboard EXPL+CTRL+9", _L("toggle custom light 9")},
    {"TRUCK_LIGHTTOGGLE10", EV_TRUCK_LIGHTTOGGLE10, "Keyboard EXPL+CTRL+0", _L("toggle custom light 10")},
    {"TRUCK_MANUAL_CLUTCH", EV_TRUCK_MANUAL_CLUTCH, "Keyboard LSHIFT", _L("manual clutch (for manual transmission)")},
    {"TRUCK_PARKING_BRAKE", EV_TRUCK_PARKING_BRAKE, "Keyboard P", _L("toggle parking brake")},
    {"TRUCK_TRAILER_PARKING_BRAKE", EV_TRUCK_TRAILER_PARKING_BRAKE, "Keyboard EXPL+CTRL+P", _L("toggle trailer parking brake")},
    {"TRUCK_ANTILOCK_BRAKE", EV_TRUCK_ANTILOCK_BRAKE, "Keyboard EXPL+SHIFT+B", _L("toggle antilock brake")},
    {"TRUCK_TOGGLE_VIDEOCAMERA", EV_TRUCK_TOGGLE_VIDEOCAMERA, "Keyboard EXPL+CTRL+V", _L("toggle videocamera")},
    {"TRUCK_TRACTION_CONTROL", EV_TRUCK_TRACTION_CONTROL, "Keyboard EXPL+SHIFT+T", _L("toggle traction control")},
    {"TRUCK_CRUISE_CONTROL", EV_TRUCK_CRUISE_CONTROL, "Keyboard EXPL+SPACE", _L("toggle cruise control")},
    {"TRUCK_CRUISE_CONTROL_READJUST", EV_TRUCK_CRUISE_CONTROL_READJUST, "Keyboard EXPL+CTRL+SPACE",
     _L("match target speed / rpm with current truck speed / rpm")},
    {"TRUCK_CRUISE_CONTROL_ACCL", EV_TRUCK_CRUISE_CONTROL_ACCL, "Keyboard EXPL+CTRL+R", _L("increase target speed / rpm")},
    {"TRUCK_CRUISE_CONTROL_DECL", EV_TRUCK_CRUISE_CONTROL_DECL, "Keyboard EXPL+CTRL+F", _L("decrease target speed / rpm")},
    {"TRUCK_SHIFT_DOWN", EV_TRUCK_SHIFT_DOWN, "Keyboard Z", _L("shift one gear down in manual transmission mode")},
    {"TRUCK_SHIFT_NEUTRAL", EV_TRUCK_SHIFT_NEUTRAL, "Keyboard D", _L("shift to neutral gear in manual transmission mode")},
    {"TRUCK_SHIFT_UP", EV_TRUCK_SHIFT_UP, "Keyboard A", _L("shift one gear up in manual transmission mode")},
    {"TRUCK_SHIFT_GEAR_REVERSE", EV_TRUCK_SHIFT_GEAR_REVERSE, "", _L("shift directly to reverse gear")},
    {"TRUCK_SHIFT_GEAR1", EV_TRUCK_SHIFT_GEAR01, "", _L("shift directly to first gear")},
    {"TRUCK_SHIFT_GEAR2", EV_TRUCK_SHIFT_GEAR02, "", _L("shift directly to second gear")},
    {"TRUCK_SHIFT_GEAR3", EV_TRUCK_SHIFT_GEAR03, "", _L("shift directly to third gear")},
    {"TRUCK_SHIFT_GEAR4", EV_TRUCK_SHIFT_GEAR04, "", _L("shift directly to fourth gear")},
    {"TRUCK_SHIFT_GEAR5", EV_TRUCK_SHIFT_GEAR05, "", _L("shift directly to 5th gear")},
    {"TRUCK_SHIFT_GEAR6", EV_TRUCK_SHIFT_GEAR06, "", _L("shift directly to 6th gear")},
    {"TRUCK_SHIFT_GEAR7", EV_TRUCK_SHIFT_GEAR07, "", _L("shift directly to 7th gear")},
    {"TRUCK_SHIFT_GEAR8", EV_TRUCK_SHIFT_GEAR08, "", _L("shift directly to 8th gear")},
    {"TRUCK_SHIFT_GEAR9", EV_TRUCK_SHIFT_GEAR09, "", _L("shift directly to 9th gear")},
    {"TRUCK_SHIFT_GEAR10", EV_TRUCK_SHIFT_GEAR10, "", _L("shift directly to 10th gear")},
    {"TRUCK_SHIFT_GEAR11", EV_TRUCK_SHIFT_GEAR11, "", _L("shift directly to 11th gear")},
    {"TRUCK_SHIFT_GEAR12", EV_TRUCK_SHIFT_GEAR12, "", _L("shift directly to 12th gear")},

    {"TRUCK_SHIFT_GEAR13", EV_TRUCK_SHIFT_GEAR13, "", _L("shift directly to 13th gear")},
    {"TRUCK_SHIFT_GEAR14", EV_TRUCK_SHIFT_GEAR14, "", _L("shift directly to 14th gear")},
    {"TRUCK_SHIFT_GEAR15", EV_TRUCK_SHIFT_GEAR15, "", _L("shift directly to 15th gear")},
    {"TRUCK_SHIFT_GEAR16", EV_TRUCK_SHIFT_GEAR16, "", _L("shift directly to 16th gear")},
    {"TRUCK_SHIFT_GEAR17", EV_TRUCK_SHIFT_GEAR17, "", _L("shift directly to 17th gear")},
    {"TRUCK_SHIFT_GEAR18", EV_TRUCK_SHIFT_GEAR18, "", _L("shift directly to 18th gear")},
    {"TRUCK_SHIFT_LOWRANGE", EV_TRUCK_SHIFT_LOWRANGE, "", _L("sets low range (1-6) for H-shaft")},
    {"TRUCK_SHIFT_MIDRANGE", EV_TRUCK_SHIFT_MIDRANGE, "", _L("sets middle range (7-12) for H-shaft")},
    {"TRUCK_SHIFT_HIGHRANGE", EV_TRUCK_SHIFT_HIGHRANGE, "", _L("sets high range (13-18) for H-shaft")},
    {"TRUCK_STARTER", EV_TRUCK_STARTER, "Keyboard S", _L("hold to start the engine")},
    {"TRUCK_STEER_LEFT", EV_TRUCK_STEER_LEFT, "Keyboard LEFT", _L("steer left")},
    {"TRUCK_STEER_RIGHT", EV_TRUCK_STEER_RIGHT, "Keyboard RIGHT", _L("steer right")},
    {"TRUCK_SWITCH_SHIFT_MODES", EV_TRUCK_SWITCH_SHIFT_MODES, "Keyboard Q", _L("toggle between transmission modes")},
    {"TRUCK_TOGGLE_INTER_AXLE_DIFF", EV_TRUCK_TOGGLE_INTER_AXLE_DIFF, "Keyboard EXPL+ALT+W",
     _L("cycle between available inter axle differential modes")},
    {"TRUCK_TOGGLE_INTER_WHEEL_DIFF", EV_TRUCK_TOGGLE_INTER_WHEEL_DIFF, "Keyboard EXPL+W",
     _L("cycle between available inter wheel differential modes")},
    {"TRUCK_TOGGLE_PHYSICS", EV_TRUCK_TOGGLE_PHYSICS, "Keyboard END", _L("toggle physics")},
    {"TRUCK_TOGGLE_TCASE_4WD_MODE", EV_TRUCK_TOGGLE_TCASE_4WD_MODE, "Keyboard EXPL+CTRL+W", _L("toggle transfer case mode")},
    {"TRUCK_TOGGLE_TCASE_GEAR_RATIO", EV_TRUCK_TOGGLE_TCASE_GEAR_RATIO, "Keyboard EXPL+SHIFT+W",
     _L("toggle transfer case gear ratio")},
    {"TRUCK_TOGGLE_CONTACT", EV_TRUCK_TOGGLE_CONTACT, "Keyboard X", _L("toggle ignition")},
    {"TRUCK_TOGGLE_FORWARDCOMMANDS", EV_TRUCK_TOGGLE_FORWARDCOMMANDS, "Keyboard EXPL+CTRL+SHIFT+F", _L("toggle forwardcommands")},
    {"TRUCK_TOGGLE_IMPORTCOMMANDS", EV_TRUCK_TOGGLE_IMPORTCOMMANDS, "Keyboard EXPL+CTRL+SHIFT+I", _L("toggle importcommands")},

    // "new" commands
    {"COMMON_FULLSCREEN_TOGGLE", EV_COMMON_FULLSCREEN_TOGGLE, "Keyboard EXPL+ALT+RETURN",
     _L("toggle between windowed and fullscreen mode")},
    {"CAMERA_FREE_MODE_FIX", EV_CAMERA_FREE_MODE_FIX, "Keyboard EXPL+ALT+C", _L("fix the camera to a position")},
    {"CAMERA_FREE_MODE", EV_CAMERA_FREE_MODE, "Keyboard EXPL+SHIFT+C", _L("enable / disable free camera mode")},
    {"TRUCK_LEFT_MIRROR_LEFT", EV_TRUCK_LEFT_MIRROR_LEFT, "Keyboard EXPL+SEMICOLON", _L("move left mirror to the left")},
    {"TRUCK_LEFT_MIRROR_RIGHT", EV_TRUCK_LEFT_MIRROR_RIGHT, "Keyboard EXPL+CTRL+SEMICOLON", _L("move left mirror to the right")},
    {"TRUCK_RIGHT_MIRROR_LEFT", EV_TRUCK_RIGHT_MIRROR_LEFT, "Keyboard EXPL+COLON", _L("more right mirror to the left")},
    {"TRUCK_RIGHT_MIRROR_RIGHT", EV_TRUCK_RIGHT_MIRROR_RIGHT, "Keyboard EXPL+CTRL+COLON", _L("move right mirror to the right")},
    {"COMMON_REPLAY_FORWARD", EV_COMMON_REPLAY_FORWARD, "Keyboard EXPL+RIGHT", _L("more replay forward")},
    {"COMMON_REPLAY_BACKWARD", EV_COMMON_REPLAY_BACKWARD, "Keyboard EXPL+LEFT", _L("more replay backward")},
    {"COMMON_REPLAY_FAST_FORWARD", EV_COMMON_REPLAY_FAST_FORWARD, "Keyboard EXPL+SHIFT+RIGHT", _L("move replay fast forward")},
    {"COMMON_REPLAY_FAST_BACKWARD", EV_COMMON_REPLAY_FAST_BACKWARD, "Keyboard EXPL+SHIFT+LEFT", _L("move replay fast backward")},
    {"AIRPLANE_AIRBRAKES_NONE", EV_AIRPLANE_AIRBRAKES_NONE, "Keyboard CTRL+3", _L("no airbrakes")},
    {"AIRPLANE_AIRBRAKES_FULL", EV_AIRPLANE_AIRBRAKES_FULL, "Keyboard CTRL+4", _L("full airbrakes")},
    {"AIRPLANE_AIRBRAKES_LESS", EV_AIRPLANE_AIRBRAKES_LESS, "Keyboard EXPL+3", _L("less airbrakes")},
    {"AIRPLANE_AIRBRAKES_MORE", EV_AIRPLANE_AIRBRAKES_MORE, "Keyboard EXPL+4", _L("more airbrakes")},
    {"AIRPLANE_THROTTLE", EV_AIRPLANE_THROTTLE, "", _L("airplane throttle")},
    {"COMMON_TRUCK_REMOVE", EV_COMMON_TRUCK_REMOVE, "Keyboard EXPL+CTRL+SHIFT+DELETE", _L("delete current truck")},
    {"COMMON_NETCHATDISPLAY", EV_COMMON_NETCHATDISPLAY, "Keyboard EXPL+SHIFT+U", _L("display or hide net chat")},
    {"COMMON_NETCHATMODE", EV_COMMON_NETCHATMODE, "Keyboard EXPL+CTRL+U", _L("toggle between net chat display modes")},
    {"CHARACTER_ROT_UP", EV_CHARACTER_ROT_UP, "Keyboard UP", _L("rotate view up")},
    {"CHARACTER_ROT_DOWN", EV_CHARACTER_ROT_DOWN, "Keyboard DOWN", _L("rotate view down")},
    {"CAMERA_UP", EV_CAMERA_UP, "Keyboard Q", _L("move camera up")},
    {"CAMERA_DOWN", EV_CAMERA_DOWN, "Keyboard Z", _L("move camera down")},
...
InputEngine::InputEngine()
    : captureMode(false), free_joysticks(0), inputsChanged(true), mForceFeedback(0), mInputManager(0), mKeyboard(0), mMouse(0),
      mappingLoaded(false), uniqueCounter(0)
{
...
bool InputEngine::setup(String hwnd, bool capture, bool capturemouse, bool captureKbd)
{
    ...
    if (captureMode)
    {
       ...
       // we get the ogre way of defining the handle, extract the window HWND only
        ...
        LOG("OIS Version: " + TOSTRING(v >> 16) + String(".") + TOSTRING((v >> 8) & 0x000000FF) + String(".") +
...
{
    OIS::MouseState m;
    if (mMouse) { m = mMouse->getMouseState(); }
    return m;
}

String InputEngine::getKeyNameForKeyCode(OIS::KeyCode keycode)
{
    if (keycode == KC_LSHIFT || keycode == KC_RSHIFT) return "SHIFT";
    if (keycode == KC_LCONTROL || keycode == KC_RCONTROL) return "CTRL";
    if (keycode == KC_LMENU || keycode == KC_RMENU) return "ALT";
    for (allit = allkeys.begin(); allit != allkeys.end(); allit++)
    {
        if (allit->second == keycode) return allit->first;
    }
    return "unknown";
}
...
{
    if (RoR::App::GetGuiManager()->keyPressed(arg)) return true;

    // LOG("*** keyPressed");
    if (keyState[arg.key] != 1) inputsChanged = true;
    keyState[arg.key] = 1;
...
{
    if (RoR::App::GetGuiManager()->keyReleased(arg)) return true;
    // LOG("*** keyReleased");
    if (keyState[arg.key] != 0) inputsChanged = true;
    keyState[arg.key] = 0;
    return true;
}
...
{
    if (RoR::App::GetGuiManager()->mouseMoved(arg)) return true;
    // LOG("*** mouseMoved");
    inputsChanged = true;
...
{
    if (RoR::App::GetGuiManager()->mousePressed(arg, id)) return true;
    // LOG("*** mousePressed");
    inputsChanged = true;
    mouseState    = arg.state;
    return true;
...
{
    if (RoR::App::GetGuiManager()->mouseReleased(arg, id)) return true;
    // LOG("*** mouseReleased");
    inputsChanged = true;
    mouseState    = arg.state;
    return true;
...
{
    // no deadzone?
    if (dz < 0.0001f) return axisValue;
...
String InputEngine::getEventCommand(int eventID)
{
    ...
    if (t_vec.size() > 0) return String(t_vec[0].configline);
    return "";
}
...
bool InputEngine::isEventDefined(int eventID)
{
    ...
    if (t_vec.size() > 0)
    {
        if (t_vec[0].eventtype != ET_NONE) return true;
    }
    return false;
}
...
int InputEngine::getKeboardKeyForCommand(int eventID)
{
    ...
    {
        event_trigger_t t = *i;
        if (t.eventtype == ET_Keyboard) return t.keyCode;
    }
    return -1;
}
...
bool InputEngine::isEventAnalog(int eventID)
{
    ...
    if (t_vec.size() > 0)
    {
        ...
        {
            if ((t_vec[i].eventtype == ET_MouseAxisX || t_vec[i].eventtype == ET_MouseAxisY ||
                 t_vec[i].eventtype == ET_MouseAxisZ || t_vec[i].eventtype == ET_JoystickAxisAbs ||
                 t_vec[i].eventtype == ET_JoystickAxisRel || t_vec[i].eventtype == ET_JoystickSliderX ||
...
float InputEngine::getEventValue(int eventID, bool pure, int valueSource)
{
    ...
    for (std::vector<event_trigger_t>::iterator i = t_vec.begin(); i != t_vec.end(); i++)
    {
        ...
        if (valueSource == 0 || valueSource == 1)
        {
            ...
            case ET_NONE: break;
            case ET_Keyboard:
                if (!keyState[t.keyCode]) break;

                // only use explicite mapping, if two keys with different modifiers exist, i.e. F1 and SHIFT+F1.
                // check for modificators
                if (t.explicite)
                {
                    if (t.ctrl != (keyState[KC_LCONTROL] || keyState[KC_RCONTROL])) break;
                    if (t.shift != (keyState[KC_LSHIFT] || keyState[KC_RSHIFT])) break;
                    if (t.alt != (keyState[KC_LMENU] || keyState[KC_RMENU])) break;
                }
                else
                {
                    if (t.ctrl && !(keyState[KC_LCONTROL] || keyState[KC_RCONTROL])) break;
            ...
            case ET_JoystickButton:
            {
                ...
                if (t.joystickButtonNumber >= (int)mJoy[t.joystickNumber]->getNumberOfComponents(OIS_Button))
                {
                    ...
                    LOG("*** Joystick has not enough buttons for mapping: need button " + TOSTRING(t.joystickButtonNumber) +
                        ", availabe buttons: " + TOSTRING(mJoy[t.joystickNumber]->getNumberOfComponents(OIS_Button)));
#endif
                    value = 0;
                    continue;
                }
            ...
            case ET_JoystickPov:
            {
                ...
                if (t.joystickPovNumber >= (int)mJoy[t.joystickNumber]->getNumberOfComponents(OIS_POV))
                {
                    ...
                    LOG("*** Joystick has not enough POVs for mapping: need POV " + TOSTRING(t.joystickPovNumber) +
                        ", availabe POVs: " + TOSTRING(mJoy[t.joystickNumber]->getNumberOfComponents(OIS_POV)));
#endif
                    value = 0;
                    continue;
                }
        ...
        if (valueSource == 0 || valueSource == 2)
        {
            switch (t.eventtype)
            {
            case ET_MouseAxisX: value = mouseState.X.abs / 32767; break;
            case ET_MouseAxisY: value = mouseState.Y.abs / 32767; break;
            case ET_MouseAxisZ: value = mouseState.Z.abs / 32767; break;
            ...
            case ET_JoystickAxisAbs:
            {
                ...
                {
#ifndef NOOGRE
                    LOG("*** Joystick has not enough axis for mapping: need axe " + TOSTRING(t.joystickAxisNumber) +
                        ", availabe axis: " + TOSTRING(joyState[t.joystickNumber].mAxes.size()));
#endif
                    value = 0;
                    continue;
                }
                ...
                if (t.eventtype == ET_JoystickAxisRel) { value = (float)axe.rel / (float)mJoy[t.joystickNumber]->MAX_AXIS; }
                else
                {
                    ...
                    if (t.joystickAxisHalf)
                    {
                        ...
                        value = (1.0 + value) / 2.0;
                        if (t.joystickAxisReverse) value = 1.0 - value;
                        if (!pure) value = axisLinearity(value, t.joystickAxisLinearity);
                    }
                    else
                    {
                        // LOG("not half: "+TOSTRING(value)+" / "+TOSTRING(deadZone(value, t.joystickAxisDeadzone)) +" /
                        // "+TOSTRING(t.joystickAxisDeadzone) );
                        if (t.joystickAxisReverse) value = 1 - value;
                        if (!pure)
            ...
            case ET_JoystickSliderY:
            {
                ...
                if (t.eventtype == ET_JoystickSliderX)
                    value = (float)joyState[t.joystickNumber].mSliders[t.joystickSliderNumber].abX /
                            (float)mJoy[t.joystickNumber]->MAX_AXIS;
                else if (t.eventtype == ET_JoystickSliderY)
                    value = (float)joyState[t.joystickNumber].mSliders[t.joystickSliderNumber].abY /
                            (float)mJoy[t.joystickNumber]->MAX_AXIS;
                value = (value + 1) / 2;                          // full axis
                if (t.joystickSliderReverse) value = 1.0 - value; // reversed
            }
            break;
            }
        }
...
String InputEngine::getDeviceName(event_trigger_t evt)
{
    ...
    case ET_MouseAxisX:
    case ET_MouseAxisY:
    case ET_MouseAxisZ: return "Mouse";
    case ET_JoystickButton:
    case ET_JoystickAxisAbs:
    case ET_JoystickAxisRel:
    case ET_JoystickPov:
    case ET_JoystickSliderX:
    case ET_JoystickSliderY: return "Joystick: " + getJoyVendor(evt.joystickNumber);
    }
    return "unknown";
}
...
bool InputEngine::processLine(char *line, int deviceID)
{
    ...
    if (strnlen(eventName, 255) == 0 || strnlen(evtype, 255) == 0) return false;
    ...
    case ET_JoystickButton:
    {
        ...
        if (!strcmp(tmp2, "!NEW!")) { strncpy(t_joy.configline, tmp2, 128); }
        else
        {
            char tmp[256] = {};
    ...
    case ET_JoystickAxisAbs:
    {
        ...
        if (relative) eventtype = ET_JoystickAxisRel;
    ...
    case ET_JoystickSliderY:
    {
        ...
        while (token != NULL)
        {
            if (strncmp(token, "REVERSE", 7) == 0) reverse = true;
...
int InputEngine::getCurrentKeyCombo(String *combo)
{
    ...
    for (i = keyState.begin(); i != keyState.end(); i++)
    {
        if (i->second)
        {
            if (i->first != KC_LSHIFT && i->first != KC_RSHIFT && i->first != KC_LCONTROL && i->first != KC_RCONTROL &&
                i->first != KC_LMENU && i->first != KC_RMENU)
                continue;
            modCounter++;
    ...
    //
    if (modCounter > 0 && keyCounter == 0) { return -modCounter; }
...
bool InputEngine::saveMapping(String outfile, String hwnd, int joyNum)
{
    ...
    for (mapIt = controls.begin(); mapIt != controls.end(); mapIt++)
    {
        ...
        for (vecIt = vec.begin(); vecIt != vec.end(); vecIt++, counter++)
        {
            ...
            if ((vecIt->eventtype == ET_MouseAxisX || vecIt->eventtype == ET_MouseAxisY || vecIt->eventtype == ET_MouseAxisZ) &&
                joyNum != -10 && joyNum != -3)
                continue;
            if ((vecIt->eventtype == ET_JoystickAxisAbs || vecIt->eventtype == ET_JoystickAxisRel ||
                 vecIt->eventtype == ET_JoystickButton || vecIt->eventtype == ET_JoystickPov ||
                 vecIt->eventtype == ET_JoystickSliderX || vecIt->eventtype == ET_JoystickSliderY) &&
                joyNum >= 0 && vecIt->joystickNumber != joyNum)
                continue;
...
bool InputEngine::loadMapping(String outfile, bool append, int deviceID)
{
    ...
    LOG(" * Loading input mapping " + outfile);
    {
        ...
        {
            size_t size = 1024;
            if (ds->tell() + size >= ds->size()) size = ds->size() - ds->tell();
            if (ds->tell() >= ds->size()) break;
            size_t readnum = ds->readLine(line, size);
            if (readnum > 5) processLine(line, deviceID);
        }
    }
#else
...
int InputEngine::resolveEventName(String eventName)
{
    ...
    {
        if (eventInfo[i].name == eventName) return eventInfo[i].eventID;
        i++;
    }
#ifndef NOOGRE
...
String InputEngine::eventIDToName(int eventID)
{
    ...
    while (i != EV_MODE_LAST)
    {
        if (eventInfo[i].eventID == eventID) return eventInfo[i].name;
        i++;
    }
    return "unknown";
}
