...
Ogre::String InputEngine::getModifierKeyName(SDL_Keymod key)
{
    switch (key)
    {
    case KMOD_LALT: return _LC("ModifierKey", "Left Alt");
    case KMOD_LSHIFT: return _LC("ModifierKey", "Left Shift");
    case KMOD_LCTRL: return _LC("ModifierKey", "Left Ctrl");

    case KMOD_RALT: return _LC("ModifierKey", "Right Alt");
    case KMOD_RSHIFT: return _LC("ModifierKey", "Right Shift");
    case KMOD_RCTRL: return _LC("ModifierKey", "Right Ctrl");
