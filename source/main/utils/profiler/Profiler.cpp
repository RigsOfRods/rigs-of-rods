...
// Author: http://www.team5150.com/~andrew/
// License: MIT
// ===========================================================================
...
*/
    ...
    struct HTMLDumper {
        HTMLDumper(const char* out_path): 
            m_out_path(out_path)
            {}
        void Init() {
...
// get an idea of how long timer calls / rdtsc takes
    ...
    void DumpHtml(const char* path) { dumpThreads( HTMLDumper(path) ); }
