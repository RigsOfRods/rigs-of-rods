...
class InputEngine : public OIS::MouseListener, public OIS::KeyListener, public OIS::JoyStickListener, public ZeroedMemoryAllocator
{
  public:
    InputEngine();
    ~InputEngine();
    ...
    std::map<int, std::vector<event_trigger_t>> &getEvents()
    {
        return events;
    };
