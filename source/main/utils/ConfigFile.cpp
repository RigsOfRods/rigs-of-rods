...
Ogre::ColourValue ConfigFile::GetColourValue(Ogre::String const &key, Ogre::String const &section,
                                             Ogre::ColourValue const &defaultValue)
{
...
Ogre::String ConfigFile::GetStringEx(Ogre::String const &key, Ogre::String const &section, Ogre::String const &defaultValue)
{
    ...
    if (setting.empty()) { return defaultValue; }
