...
class SlideNode
{
  public:
    ...
    {
        m_initial_threshold = m_cur_threshold = fabs(threshold);
  ...
  private:
    ...
    float m_attach_rate; //!< How fast the cur threshold changes when attaching (i.e. how long it will take for springs to fully
                         //!< attach to the Rail) (m/s)
