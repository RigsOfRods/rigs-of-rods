...
static const int   MAX_COMMANDS               = 84;              //!< maximum number of commandkeys per actor (number of 'commands' [command hydro beams in RoR jargon] is not limited - one commandkey can control multiple 'commands')
