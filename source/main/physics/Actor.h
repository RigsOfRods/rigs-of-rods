...
public:
    ...
    ProjectPtr        GetProject() const                { return m_project; }
...
private:
    ...
    CacheEntry*       m_cache_entry;           //!< ModCache info (if used on spawn)
    ProjectPtr        m_project;               //!< ProjectManager info (if used on spawn)
