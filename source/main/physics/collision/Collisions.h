...
class Collisions : public ZeroedMemoryAllocator
{
  ...
  private:
    ...
    struct hash_coll_element_t
    {
        ...
        inline bool IsCollisionBox() const
        {
            return element_index < ELEMENT_TRI_BASE_INDEX;
        }
        inline bool IsCollisionTri() const
        {
            return element_index >= ELEMENT_TRI_BASE_INDEX;
        }
    ...
    inline int          GetNumCollisionTris() const
    {
        return static_cast<int>(m_collision_tris.size());
    }
    inline int GetNumCollisionBoxes() const
    {
        return static_cast<int>(m_collision_boxes.size());
    }
  ...
  public:
    ...
    int  addCollisionBox(Ogre::SceneNode *tenode, bool rotating, bool virt, Ogre::Vector3 pos, Ogre::Vector3 rot, Ogre::Vector3 l,
                         Ogre::Vector3 h, Ogre::Vector3 sr, const Ogre::String &eventname, const Ogre::String &instancename,
                         bool forcecam, Ogre::Vector3 campos, Ogre::Vector3 sc = Ogre::Vector3::UNIT_SCALE,
                         Ogre::Vector3 dr = Ogre::Vector3::ZERO, int event_filter = EVENT_ALL, int scripthandler = -1);
    int  addCollisionMesh(Ogre::String meshname, Ogre::Vector3 pos, Ogre::Quaternion q, Ogre::Vector3 scale,
    ...
    void getMeshInformation(Ogre::Mesh *mesh, size_t &vertex_count, Ogre::Vector3 *&vertices, size_t &index_count,
                            unsigned *&indices, const Ogre::Vector3 &position = Ogre::Vector3::ZERO,
                            const Ogre::Quaternion &orient = Ogre::Quaternion::IDENTITY,
                            const Ogre::Vector3 &   scale  = Ogre::Vector3::UNIT_SCALE);
};

Ogre::Vector3 primitiveCollision(node_t *node, Ogre::Vector3 velocity, float mass, Ogre::Vector3 normal, float dt,
                                 ground_model_t *gm, float penetration = 0);
