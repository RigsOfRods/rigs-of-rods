...
public:
    ...
    void reset();
    void disconnect();
    bool getCustomAutopilotMode() { return custom_autopilot_mode; }
...
private:
    ...
    // Custom autopilot mode:
    // Prevents the default A/P from controlling the aircraft and disables the
