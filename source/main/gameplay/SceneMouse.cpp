...
{
	if (Application::GetActiveSimState() == Application::SIM_STATE_PAUSED) { return; } // Do nothing when paused
...
{
    if (Application::GetActiveSimState() == Application::SIM_STATE_PAUSED) { return true; } // Do nothing when paused
