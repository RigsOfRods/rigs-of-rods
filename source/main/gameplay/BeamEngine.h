...
class EngineSim : public ZeroedMemoryAllocator
{
  ...
  public:
    ...
    void PushNetworkState(float engine_rpm, float acc, float clutch, int gear, bool running, bool contact, char auto_mode,
                          char auto_select = -1);
    ...
    void SetEngineOptions(float einertia, char etype, float eclutch, float ctime, float stime, float pstime, float irpm,
    ...
    void SetTurboOptions(int type, float tinertiaFactor, int nturbos, float param1, float param2, float param3, float param4,
                         float param5, float param6, float param7, float param8, float param9, float param10, float param11);
    ...
    bool                HasStarterContact() const
    {
        return m_starter_has_contact;
    };
    bool HasTurbo() const
    {
        return m_engine_has_turbo;
    };
    bool IsRunning() const
    {
        return m_engine_is_running;
    };
    int GetAutoMode() const
    {
        return static_cast<int>(m_auto_mode);
    };
    ...
    {
        return m_engine_idle_rpm;
    };
    float getMaxRPM() const
    {
        return m_engine_max_rpm;
    };
    float getMinRPM() const
    {
        return m_engine_min_rpm;
    };
    int getNumGears() const
    {
        return static_cast<int>(m_gear_ratios.size() - 2);
    };
    ...
    {
        return m_cur_engine_torque;
    }
    float GetInputShaftRpm()
    {
        return m_cur_wheel_revolutions * m_gear_ratios[m_cur_gear + 1];
    };
    float GetDriveRatio()
    {
        return m_gear_ratios[m_cur_gear + 1];
    };
    float GetEngineInertia()
    {
        return m_engine_inertia;
    };
    float getEnginePower()
    {
        return getEnginePower(m_cur_engine_rpm);
    };
