...
void RoRFrameListener::EnterGameplayLoop()
{
    ...
    {
        // ##### Simulation loop #####
        Ogre::RenderWindow * const window    = RoR::App::GetOgreSubsystem()->GetRenderWindow();
        Ogre::Root* const          ogre_root = RoR::App::GetOgreSubsystem()->GetOgreRoot();
        while ((App::app_state.GetPending() == AppState::SIMULATION)
