...
Character::Character(CacheEntry* cacheEntry, CacheEntry* skinEntry, CharacterDocumentPtr def, int source, unsigned int streamid, UTFString player_name, int color_number, bool is_remote) :
