    ...
    class SequentialImporter
    {
      public:
        struct NodeMapEntry
        {
            ...
            NodeMapEntry(File::Keyword keyword, Node::Id id, unsigned node_sub_index,
                         OriginDetail detail = NodeMapEntry::DETAIL_UNDEFINED)
                : origin_keyword(keyword), origin_detail(detail), node_sub_index(node_sub_index), node_id(id)
            {
            }
