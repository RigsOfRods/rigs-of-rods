...
enum MsgType
{
    ...
    MSG_NET_INSTALL_REPOFILE_REQUESTED,    //!< Payload = RoR::RepoFileInstallRequest* (owner)
    MSG_NET_INSTALL_REPOFILE_SUCCESS,      //!< Payload = int* (owner)
    MSG_NET_INSTALL_REPOFILE_FAILURE,      //!< Payload = int* (owner)
    MSG_NET_INSTALL_REPOFILE_PROGRESS,     //!< Payload = int* (owner)
    // Simulation
