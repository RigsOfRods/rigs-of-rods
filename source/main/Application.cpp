...
namespace RoR
{
    namespace App
    {
        ...
        GVarPod_APS<bool>     app_async_physics("app_async_physics", "AsyncPhysics", true, true, true);
        GVarPod_APS<int>      app_num_workers("app_num_workers", "NumWorkerThreads", 0, 0, 0);
        ...
        GVarEnum_AP<SimGearboxMode> sim_gearbox_mode("sim_gearbox_mode", "GearboxMode", SimGearboxMode::AUTO,
                                                     SimGearboxMode::AUTO);
        ...
        GVarPod_A<bool>   diag_trace_globals("diag_trace_globals", nullptr,
        ...
        GVarEnum_AP<IoInputGrabMode> io_input_grab_mode("io_input_grab_mode", "Input Grab", IoInputGrabMode::ALL,
                                                        IoInputGrabMode::ALL);
        ...
        // Graphics
        GVarEnum_AP<GfxFlaresMode> gfx_flares_mode("gfx_flares_mode", "Lights", GfxFlaresMode::ALL_VEHICLES_ALL_LIGHTS,
                                                   GfxFlaresMode::ALL_VEHICLES_ALL_LIGHTS);
        GVarEnum_AP<GfxShadowType> gfx_shadow_type("gfx_shadow_type", "Shadow technique", GfxShadowType::PSSM,
                                                   GfxShadowType::PSSM);
        GVarEnum_AP<GfxExtCamMode> gfx_extcam_mode("gfx_extcam_mode", "External Camera Mode", GfxExtCamMode::PITCHING,
                                                   GfxExtCamMode::PITCHING);
        GVarEnum_AP<GfxSkyMode>    gfx_sky_mode("gfx_sky_mode", "Sky effects", GfxSkyMode::CAELUM, GfxSkyMode::CAELUM);
        GVarEnum_AP<GfxTexFilter>  gfx_texture_filter("gfx_texture_filter", "Texture Filtering", GfxTexFilter::ANISOTROPIC,
                                                     GfxTexFilter::ANISOTROPIC);
        GVarEnum_AP<GfxVegetation> gfx_vegetation_mode("gfx_vegetation_mode", "Vegetation", GfxVegetation::FULL,
                                                       GfxVegetation::FULL);
        GVarEnum_AP<GfxWaterMode>  gfx_water_mode("gfx_water_mode", "Water effects", GfxWaterMode::FULL_FAST,
