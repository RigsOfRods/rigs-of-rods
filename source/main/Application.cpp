...
const char* MsgTypeToString(MsgType type)
{
    ...
    case MSG_NET_INSTALL_REPOFILE_REQUESTED   : return "MSG_NET_INSTALL_REPOFILE_REQUESTED";
    case MSG_NET_INSTALL_REPOFILE_SUCCESS     : return "MSG_NET_INSTALL_REPOFILE_SUCCESS";
    case MSG_NET_INSTALL_REPOFILE_FAILURE     : return "MSG_NET_INSTALL_REPOFILE_FAILURE";
    case MSG_NET_INSTALL_REPOFILE_PROGRESS    : return "MSG_NET_INSTALL_REPOFILE_PROGRESS";
