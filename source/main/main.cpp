...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        else
        {
            ...
            ror_homedir << user_home << PATH_SLASH << "RigsOfRods";
#endif
            CreateFolderIfNotExists (ror_homedir.ToCStr ());  
        ...
        CreateFolderIfNotExists(logs_dir.ToCStr());
        ...
        CreateFolderIfNotExists(App::sys_cache_dir.GetActive());
        CreateFolderIfNotExists(App::sys_config_dir.GetActive());
        CreateFolderIfNotExists(App::sys_screenshot_dir.GetActive());
