...
class TerrainManager : public ZeroedMemoryAllocator
{
  public:
    ...
    {
        return m_def.category_id;
    };
    int getVersion() const
    {
        return m_def.version;
    };
    int getFarClip() const
    {
        return m_sight_range;
    }
    float getPagedDetailFactor() const
    {
        return m_paged_detail_factor;
    };
    float getWaterHeight() const
    {
        return m_def.water_height;
    };
    ...
    {
        return m_def.start_position;
    };
    RoR::Terrn2Def &GetDef()
    {
        return m_def;
    }
    HydraxWater *getHydraxManager()
    {
        return m_hydrax_water;
    }
