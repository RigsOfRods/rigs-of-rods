    ...
    */
    class ShaderParticleRenderer : public ParticleSystemRenderer, public Renderable
    {
      protected:
        ...
        /// * position will be always present in vertex format (don't need to specify) - float4 - w component is vertex index
        /// (0-3)
        ...
        bool mVertexFormatTimeFragmentInv; ///< particle inverse time fragment (1.0f - ttl / total ttl) (float1) (value 0.0f
                                           ///< - 1.0f)
        size_t  mVertexSize;
      ...
      public:
        ...
        virtual void _updateRenderQueue(RenderQueue *queue, Ogre::list<Particle *>::type &currentParticles,
