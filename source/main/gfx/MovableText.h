...
namespace Ogre
{
    ...
    class MovableText : public MovableObject, public Renderable
    {
      ...
      protected:
        ...
        /******************************** public methods ******************************/
      public:
        MovableText(const UTFString &name, const UTFString &caption, const UTFString &fontName = "highcontrast_black",
                    Real charHeight = 1.0, const ColourValue &color = ColourValue::Black);
        virtual ~MovableText();
        ...
        // Get settings
        const UTFString &getFontName() const
        {
            return mFontName;
        }
        const UTFString &getCaption() const
        {
            return mCaption;
        }
        ...
        {
            return (uint)mCharHeight;
        }
        uint getSpaceWidth() const
        {
            return (uint)mSpaceWidth;
        }
        Real getAdditionalHeight() const
        {
