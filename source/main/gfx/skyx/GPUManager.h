...
namespace SkyX
{
    ...
    class GPUManager
    {
      public:
         ...
         */
        void addGroundPass(Ogre::Pass *GroundPass, const Ogre::Real &AtmosphereRadius,
         ...
         */
        void setGpuProgramParameter(const GpuProgram &GpuP, const Ogre::String &Name, const int &Value,
        ...
        /** Set gpu program Ogre::Real parameter
            ...
            @param UpdateGroundPasses true to update ground passes
         */
        void setGpuProgramParameter(const GpuProgram &GpuP, const Ogre::String &Name, const Ogre::Real &Value,
                                    const bool &UpdateGroundPasses = true);
        ...
        /** Set gpu program Ogre::Vector2 parameter
            ...
            @param UpdateGroundPasses true to update ground passes
         */
        void setGpuProgramParameter(const GpuProgram &GpuP, const Ogre::String &Name, const Ogre::Vector2 &Value,
                                    const bool &UpdateGroundPasses = true);
        ...
        /** Set gpu program Ogre::Vector3 parameter
            ...
            @param UpdateGroundPasses true to update ground passes
         */
        void setGpuProgramParameter(const GpuProgram &GpuP, const Ogre::String &Name, const Ogre::Vector3 &Value,
                                    const bool &UpdateGroundPasses = true);
