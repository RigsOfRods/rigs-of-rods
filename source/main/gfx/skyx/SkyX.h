    ...
    class SkyX : public Ogre::FrameListener, public Ogre::RenderTargetListener
    {
      public:
        ...
        struct RenderQueueGroups
        {
             ...
             */
            inline RenderQueueGroups(const Ogre::uint8 &s, const Ogre::uint8 &vc, const Ogre::uint8 &vclu,
        ...
        /** Set infinite camera far clip distance
            ...
            @remarks SkyX needs a finite camera far clip distance in order to builds its geometry. Since Ogre allows infinite far
           clip camera distances (camearFarClipDistance = 0) you'll need to manually provide a far clip distance if you're using
