    ...
    namespace VClouds
    {
        ...
        class DataManager
        {
          public:
            ...
            /** Set update time
                @param UpdateTime Time elapsed between data calculations, a little freeze could be experimented during these
               calculations on old CPU's
             */
          ...
          private:
            ...
            */
             ...
             */
            void _performCalculations(const int &nx, const int &ny, const int &nz, const int &step, const int &xStart,
                                      const int &xEnd);
             ...
             */
            const float _getDensityAt(Cell ***c, const int &nx, const int &ny, const int &nz, const int &x, const int &y,
            ...
            /** Fact funtion
                ...
                @param z z Coord
             */
            const bool _fact(Cell ***c, const int &nx, const int &ny, const int &nz, const int &x, const int &y,
                             const int &z) const;
             ...
             */
            const Ogre::Real _getLightAbsorcionAt(Cell ***c, const int &nx, const int &ny, const int &nz, const int &x,
                                                  const int &y, const int &z, const Ogre::Vector3 &d, const float &att) const;
