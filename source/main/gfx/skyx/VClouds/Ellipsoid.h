    ...
    namespace VClouds
    {
        ...
        class Ellipsoid
        {
          public:
             ...
             */
            Ellipsoid(const int &a, const int &b, const int &c, const int &nx, const int &ny, const int &nz, const int &x,
                      const int &y, const int &z, const Ogre::Real &DynLibManager = 1.0f);
