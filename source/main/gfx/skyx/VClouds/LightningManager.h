    ...
    namespace VClouds
    {
        ...
        class LightningManager
        {
          public:
             ...
             */
            Lightning *addLightning(const Ogre::Vector3 &p, const Ogre::Vector3 &d, const Ogre::Real l,
            ...
            /** Get whether the lightning system is enabled or not
                ...
                @remarks Even if the lightning system is disabled, you'll be able to manually add lightnings trhough
               LightningManager::addLightning(...)
             */
