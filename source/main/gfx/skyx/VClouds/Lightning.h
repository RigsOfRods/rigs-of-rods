          ...
          public:
            ...
            struct Segment
            {
              public:
                /** Default constructor
                 */
                Segment() : a(Ogre::Vector3()), b(Ogre::Vector3())
                {
                }
                 ...
                 */
                Segment(const Ogre::Vector3 &a_, const Ogre::Vector3 &b_) : a(a_), b(b_)
                {
                }
            ...
            /** Constructor
                ...
                @param b Bounds
             */
            Lightning(Ogre::SceneManager *sm, Ogre::SceneNode *sn, const Ogre::Vector3 &orig, const Ogre::Vector3 &dir,
                      const Ogre::Real &l, const Ogre::uint32 &d, const Ogre::uint32 &rec, const Ogre::Real &tm,
                      const Ogre::Real &wm, const Ogre::Vector2 &b = Ogre::Vector2(0, 1));
