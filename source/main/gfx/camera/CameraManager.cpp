...
bool CameraManager::handleMouseMoved(const OgreBites::MouseMotionEvent& _arg)
{
...
bool CameraManager::handleMouseWheelRolled(const OgreBites::MouseWheelEvent& _arg)
{
    if (App::sim_state->getEnum<SimState>() == SimState::PAUSED)
    {
        return true; // Do nothing when paused
