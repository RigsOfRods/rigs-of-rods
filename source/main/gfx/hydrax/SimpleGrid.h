        ...
        class SimpleGrid : public Module
        {
          public:
            ...
            struct Options
            {
                 ...
                 */
                Options()
                    : Complexity(256), MeshSize(Size(100)), Strength(32.5f), Smooth(false), ChoppyWaves(true),
                ...
                Options(const int &_Complexity, const Size &_MeshSize)
                    : Complexity(_Complexity), MeshSize(_MeshSize), Strength(32.5f), Smooth(false), ChoppyWaves(true),
                      ChoppyStrength(0.065f)
                {
                }
                 ...
                 */
                Options(const int &_Complexity, const Size &_MeshSize, const float &_Strength, const bool &_Smooth,
                        const bool &_ChoppyWaves, const float &_ChoppyStrength)
                    : Complexity(_Complexity), MeshSize(_MeshSize), Strength(_Strength), Smooth(_Smooth),
                      ChoppyWaves(_ChoppyWaves), ChoppyStrength(_ChoppyStrength)
                {
                }
            };
