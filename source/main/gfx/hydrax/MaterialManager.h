    ...
    class MaterialManager
    {
      public:
        ...
        struct Options
        {
            /** Default constructor
             */
            Options() : SM(SM_HLSL), NM(NM_TEXTURE)
            {
            }
             ...
             */
            Options(const ShaderMode &_SM, const NormalMode &_NM) : SM(_SM), NM(_NM)
            {
            }
         ...
         */
        bool fillGpuProgramsToPass(Ogre::Pass *Pass, const Ogre::String GpuProgramNames[2], const ShaderMode &SM,
        ...
        /** Create GPU program
            ...
            @param Data
         */
        bool createGpuProgram(const Ogre::String &Name, const ShaderMode &SM, const GpuProgram &GPUP,
        ...
        /** Add depth texture technique to an especified material
            ...
            @remarks Call it after Hydrax::create()/Hydrax::setComponents(...)
                     ...
                     This depth technique will be added with "HydraxDepth" scheme in ordeto can use it in the Depth RTT.
         */
        void addDepthTextureTechnique(Ogre::Technique *Technique, const Ogre::String &TextureName,
                                      const Ogre::String &AlphaChannel = "w", const bool &AutoUpdate = true);
        ...
        /** Set gpu program Ogre::Real parameter
            ...
            @param Value value
         */
        void setGpuProgramParameter(const GpuProgram &GpuP, const MaterialType &MType, const Ogre::String &Name,
      ...
      private:
         ...
         */
        bool _createDepthTextureGPUPrograms(const HydraxComponent &Components, const Options &Options,
         ...
         */
        bool _createSimpleColorMaterial(const Ogre::ColourValue &Color, const MaterialType &MT, const Ogre::String &Name,
                                        const bool &DepthCheck = true, const bool &DepthWrite = true);
