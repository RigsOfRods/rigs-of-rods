...
namespace Hydrax
{
    Ogre::Vector2 Math::intersectionOfTwoLines(const Ogre::Vector2 &a, const Ogre::Vector2 &b, const Ogre::Vector2 &c,
                                               const Ogre::Vector2 &d)
    {
        ...
        if (denominator == 0) { return Ogre::Vector2::ZERO; }
        ...
        if (r < 0 || r > 1 || s < 0 || s > 1) { return Ogre::Vector2::ZERO; }
        ...
        return Ogre::Vector2((a.x + (r * (b.x - a.x))), (a.y + (r * (b.y - a.y))));
    }
} // namespace Hydrax
