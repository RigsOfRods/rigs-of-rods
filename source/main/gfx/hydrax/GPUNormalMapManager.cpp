...
namespace Hydrax
{
    GPUNormalMapManager::GPUNormalMapManager(Hydrax *h) : mHydrax(h), mRttManager(h->getRttManager()), mCreated(false)
    {
    ...
    void GPUNormalMapManager::remove()
    {
        ...
        Ogre::HighLevelGpuProgramManager::getSingleton().unload(
