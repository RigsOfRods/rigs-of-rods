        ...
        class RadialGrid : public Module
        {
          public:
            ...
            struct Options
            {
                 ...
                 */
                Options()
                    : Steps(250), Circles(250), Radius(100), Smooth(false), ChoppyWaves(true), ChoppyStrength(3.5f),
                      StepSizeCube(0.00001f), StepSizeFive(0.0f), StepSizeLin(0.1f), Strength(32.5f)
                {
                }
                ...
                Options(const int &_Steps, const int &_Circles, const float &_Radius)
                    : Steps(_Steps), Circles(_Circles), Radius(_Radius), Smooth(false), ChoppyWaves(true), ChoppyStrength(3.5f),
                      StepSizeCube(0.00001f), StepSizeFive(0.0f), StepSizeLin(0.1f), Strength(32.5f)
                {
                }
                 ...
                 */
                Options(const int &_Steps, const int &_Circles, const float &_Radius, const bool &_Smooth,
                        const bool &_ChoppyWaves, const float &_ChoppyStrength, const float &_StepSizeCube,
                        const float &_StepSizeFive, const float &_StepSizeLin, const float &_Strength)
                    : Steps(_Steps), Circles(_Circles), Radius(_Radius), Smooth(_Smooth), ChoppyWaves(_ChoppyWaves),
                      ChoppyStrength(_ChoppyStrength), StepSizeCube(_StepSizeCube), StepSizeFive(_StepSizeFive),
                      StepSizeLin(_StepSizeLin), Strength(_Strength)
                {
                }
            };
