      ...
      public:
        ...
        struct Pixel
        {
            ...
            /** Constructor
                @param v RGBA Value
             */
            Pixel(const float &v) : red(v), green(v), blue(v), alpha(v)
            {
            }
             ...
             */
            Pixel(const float &r, const float &g, const float &b) : red(r), green(g), blue(b), alpha(0)
            {
            }
            ...
            /** Constructor
                ...
                @param a Alpha value
             */
            Pixel(const float &r, const float &g, const float &b, const float &a) : red(r), green(g), blue(b), alpha(a)
            {
            }
