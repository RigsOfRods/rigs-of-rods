        ...
        class ProjectedGrid : public Module
        {
          public:
            ...
            struct Options
            {
                 ...
                 */
                Options()
                    : Complexity(256), Strength(35.0f), Elevation(50.0f), Smooth(false), ForceRecalculateGeometry(false),
                      ChoppyWaves(true), ChoppyStrength(3.75f)
                {
                }
                ...
                Options(const int &_Complexity)
                    : Complexity(_Complexity), Strength(35.0f), Elevation(50.0f), Smooth(false), ForceRecalculateGeometry(false),
                      ChoppyWaves(true), ChoppyStrength(3.75f)
                {
                }
                ...
                Options(const int &_Complexity, const float &_Strength, const float &_Elevation, const bool &_Smooth)
                    : Complexity(_Complexity), Strength(_Strength), Elevation(_Elevation), Smooth(_Smooth),
                      ForceRecalculateGeometry(false), ChoppyWaves(true), ChoppyStrength(3.75f)
                {
                }
                 ...
                 */
                Options(const int &_Complexity, const float &_Strength, const float &_Elevation, const bool &_Smooth,
                        const bool &_ForceRecalculateGeometry, const bool &_ChoppyWaves, const float &_ChoppyStrength)
                    : Complexity(_Complexity), Strength(_Strength), Elevation(_Elevation), Smooth(_Smooth),
                      ForceRecalculateGeometry(_ForceRecalculateGeometry), ChoppyWaves(_ChoppyWaves),
