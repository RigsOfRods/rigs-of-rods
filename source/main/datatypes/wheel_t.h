...
struct wheel_t
{
    enum class BrakeCombo /// Wheels are braked by three mechanisms: A footbrake, a handbrake/parkingbrake, and directional brakes
                          /// used for skidsteer steering.
    {
        ...
        FOOT_HAND_SKID_LEFT,  /// - 2 = yes footbrake, yes handbrake, yes direction control (braked when vehicle steers to the
                              /// left)
        FOOT_HAND_SKID_RIGHT, /// - 3 = yes footbrake, yes handbrake, yes direction control (braked when vehicle steers to the
                              /// right)
        FOOT_ONLY /// - 4 = yes footbrake, no  handbrake, no  direction control -- footbrake only, such as with the front wheels
                  /// of a passenger car
    };
