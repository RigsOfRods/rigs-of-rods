...
#define E_COMMA_SPACES "[[:blank:]]*,[[:blank:]]*"
...
DEFINE_REGEX( SECTION_COMMANDS,
	...
	E_CAPTURE_OPTIONAL( /* #14 */
		...
		E_CAPTURE_OPTIONAL( /* #17 */
			...
			E_CAPTURE( E_DELIMITER_SPACE E_OR E_COMMA_SPACES ) /* #20 */
...
DEFINE_REGEX( SECTION_PROPS,
	...
	E_CAPTURE(                         /* #10 Delimiter wrapper */
		E_CAPTURE( E_COMMA_SPACES )    /* #11 Correct delimiter */
		E_OR
...
DEFINE_REGEX( SECTION_SHOCKS,
	...
	E_CAPTURE_OPTIONAL( /* #10 Invalid input */
		E_CAPTURE( E_COMMA_SPACES E_OR E_DELIMITER_SPACE )
...
DEFINE_REGEX( SECTION_,
	...
	E_CAPTURE( E_REAL_NUMBER ) /*  */
	E_COMMA_SPACES
	E_CAPTURE_OPTIONAL( E_COMMA_SPACES )
...
#undef E_SLASH
#undef E_REAL_NUMBER
#undef E_COMMA_SPACES
#undef E_COLON_SPACES
