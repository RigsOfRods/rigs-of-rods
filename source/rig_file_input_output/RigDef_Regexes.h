...
DEFINE_REGEX( SECTION_BEAMS,
	...
	E_CAPTURE_OPTIONAL( 
		E_CAPTURE( E_DELIMITER )
		E_CAPTURE( E_STRING_ALNUM_HYPHENS_USCORES_ONLY ) /* #6 Options */
...
DEFINE_REGEX( SECTION_COMMANDS,
	...
	E_CAPTURE_OPTIONAL(                     // #14
		E_CAPTURE( E_DELIMITER )
		E_CAPTURE( E_STRING_ANYTHING_BUT_WHITESPACE ) // #16 Options
...
DEFINE_REGEX( SECTION_COMMANDS_2,
	...
	E_CAPTURE_OPTIONAL(                       // #16
		E_CAPTURE( E_DELIMITER ) 
		E_CAPTURE( E_STRING_ANYTHING_BUT_WHITESPACE ) // #18 Options
...
DEFINE_REGEX( SECTION_NODES,
	...
	E_CAPTURE_OPTIONAL( 
		E_CAPTURE( E_DELIMITER )
		E_CAPTURE( E_STRING_NO_SPACES ) /* #10 Options */
